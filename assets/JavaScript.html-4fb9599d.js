import{_ as i,M as l,p as o,q as p,R as n,t as s,N as e,a1 as t}from"./framework-96b046e1.js";const c={},r=t(`<h1 id="javascript知识点总结" tabindex="-1"><a class="header-anchor" href="#javascript知识点总结" aria-hidden="true">#</a> JavaScript知识点总结</h1><h2 id="_1-介绍-js-的基本数据类型。" tabindex="-1"><a class="header-anchor" href="#_1-介绍-js-的基本数据类型。" aria-hidden="true">#</a> 1. 介绍 js 的基本数据类型。</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>js 一共有五种基本数据类型，分别是 Undefined、Null、Boolean、Number、String，还有在 ES6 中新增的 Symbol 和 ES10 中新增的 BigInt 类型。
Symbol 代表创建后独一无二且不可变的数据类型，它的出现我认为主要是为了解决可能出现的全局变量冲突的问题。
BigInt 是一种数字类型的数据，它可以表示任意精度格式的整数，使用 BigInt 可以安全地存储和操作大整数，即使这个数已经超出了 Number 能够表示的安全整数范围。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-javascript-有几种类型的值-你能画一下他们的内存图吗" tabindex="-1"><a class="header-anchor" href="#_2-javascript-有几种类型的值-你能画一下他们的内存图吗" aria-hidden="true">#</a> 2. JavaScript 有几种类型的值？你能画一下他们的内存图吗？</h2><p>涉及知识点：</p><ul><li>栈：原始数据类型（Undefined、Null、Boolean、Number、String）</li><li>堆：引用数据类型（对象、数组和函数）</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>两种类型的区别是：存储位置不同。
...
体。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>回答：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>js 可以分为两种类型的值，一种是基本数据类型，一种是复杂数据类型。
...
保存对应的指针来获取堆中的值。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),u={href:"https://blog.csdn.net/lxcao/article/details/52749421",target:"_blank",rel:"noopener noreferrer"},d={href:"https://blog.csdn.net/jiangjuanjaun/article/details/80327342",target:"_blank",rel:"noopener noreferrer"},v=t(`<h2 id="_3-什么是堆-什么是栈-它们之间有什么区别和联系" tabindex="-1"><a class="header-anchor" href="#_3-什么是堆-什么是栈-它们之间有什么区别和联系" aria-hidden="true">#</a> 3. 什么是堆？什么是栈？它们之间有什么区别和联系？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>堆和栈的概念存在于数据结构中和操作系统内存中。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),m={href:"https://www.zhihu.com/question/19729973",target:"_blank",rel:"noopener noreferrer"},k=t(`<h2 id="_4-内部属性-class-是什么" tabindex="-1"><a class="header-anchor" href="#_4-内部属性-class-是什么" aria-hidden="true">#</a> 4. 内部属性 [[Class]] 是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>所有 typeof 返回值为 &quot;object&quot; 的对象（如数组）都包含一个内部属性 [[Class]]（我们可以把它看作一个内部的分类，而非
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-介绍-js-有哪些内置对象" tabindex="-1"><a class="header-anchor" href="#_5-介绍-js-有哪些内置对象" aria-hidden="true">#</a> 5. 介绍 js 有哪些内置对象？</h2><p>涉及知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>全局的对象（ global objects ）或称标准内置对象，不要和 &quot;全局对象（global object）&quot; 混淆。这里说的全局的对象是说在
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),b={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects",target:"_blank",rel:"noopener noreferrer"},h={href:"https://segmentfault.com/a/1190000011467723#articleHeader24",target:"_blank",rel:"noopener noreferrer"},g=t(`<h2 id="_6-undefined-与-undeclared-的区别" tabindex="-1"><a class="header-anchor" href="#_6-undefined-与-undeclared-的区别" aria-hidden="true">#</a> 6. undefined 与 undeclared 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>已在作用域中声明但还没有赋值的变量，是 undefined 的。相反，还没有在作用域中声明过的变量，是 undeclared 的。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),f={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8Bundefined%E4%B8%8Enull.html",target:"_blank",rel:"noopener noreferrer"},_=t(`<h2 id="_8-如何获取安全的-undefined-值" tabindex="-1"><a class="header-anchor" href="#_8-如何获取安全的-undefined-值" aria-hidden="true">#</a> 8. 如何获取安全的 undefined 值？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>因为 undefined 是一个标识符，所以可以被当作变量来使用和赋值，但是这样会影响 undefined 的正常判断。
...
（7）if 语句必须使用大括号。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_10-javascript-原型-原型链-有什么特点" tabindex="-1"><a class="header-anchor" href="#_10-javascript-原型-原型链-有什么特点" aria-hidden="true">#</a> 10. JavaScript 原型，原型链？ 有什么特点？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在 js 中我们是使用构造函数来新建一个对象的，每一个构造函数的内部都有一个 prototype 属性值，这个属性值是一个对
...
之相关的对象也会继承这一改变。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),x={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8B%E5%8E%9F%E5%9E%8B%E4%B8%8E%E5%8E%9F%E5%9E%8B%E9%93%BE.html",target:"_blank",rel:"noopener noreferrer"},y=t(`<h2 id="_11-js-获取原型的方法" tabindex="-1"><a class="header-anchor" href="#_11-js-获取原型的方法" aria-hidden="true">#</a> 11. js 获取原型的方法？</h2><ul><li>p.__proto__</li><li>p.constructor.prototype</li><li>Object.getPrototypeOf(p)</li></ul><h2 id="_12-在-js-中不同进制数字的表示方式" tabindex="-1"><a class="header-anchor" href="#_12-在-js-中不同进制数字的表示方式" aria-hidden="true">#</a> 12. 在 js 中不同进制数字的表示方式</h2><ul><li><p>以 0X、0x 开头的表示为十六进制。</p></li><li><p>以 0、0O、0o 开头的表示为八进制。</p></li><li><p>以 0B、0b 开头的表示为二进制格式。</p></li></ul><h2 id="_13-js-中整数的安全范围是多少" tabindex="-1"><a class="header-anchor" href="#_13-js-中整数的安全范围是多少" aria-hidden="true">#</a> 13. js 中整数的安全范围是多少？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>安全整数指的是，在这个范围内的整数转化为二进制存储的时候不会出现精度丢失，能够被“安全”呈现的最大整数是 2^53 - 1，
...
来判断。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_14-typeof-nan-的结果是什么" tabindex="-1"><a class="header-anchor" href="#_14-typeof-nan-的结果是什么" aria-hidden="true">#</a> 14. typeof NaN 的结果是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>NaN 意指“不是一个数字”（not a number），NaN 是一个“警戒值”（sentinel value，有特殊用途的常规值），用于指出
...
为 true。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_15-isnan-和-number-isnan-函数的区别" tabindex="-1"><a class="header-anchor" href="#_15-isnan-和-number-isnan-函数的区别" aria-hidden="true">#</a> 15. isNaN 和 Number.isNaN 函数的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>函数 isNaN 接收参数后，会尝试将这个参数转换为数值，任何不能被转换为数值的的值都会返回 true，因此非数字值传入也会
返回 true ，会影响 NaN 的判断。

函数 Number.isNaN 会首先判断传入参数是否为数字，如果是数字再继续判断是否为 NaN ，这种方法对于 NaN 的判断更为
准确。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_16-array-构造函数只有一个参数值时的表现" tabindex="-1"><a class="header-anchor" href="#_16-array-构造函数只有一个参数值时的表现" aria-hidden="true">#</a> 16. Array 构造函数只有一个参数值时的表现？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Array 构造函数只带一个数字参数的时候，该参数会被作为数组的预设长度（length），而非只充当数组中的一个元素。这样
...
（5）对普通对象来说，除非自行定义 toString() 方法，否则会调用 toString()（Object.prototype.toString()）
    ...
    调用该方法并使用其返回值。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_18-其他值到数字值的转换规则" tabindex="-1"><a class="header-anchor" href="#_18-其他值到数字值的转换规则" aria-hidden="true">#</a> 18. 其他值到数字值的转换规则？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>有时我们需要将非数字值当作数字来使用，比如数学运算。为此 ES5 规范在 9.3 节定义了抽象操作 ToNumber。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_19-其他值到布尔类型的值的转换规则" tabindex="-1"><a class="header-anchor" href="#_19-其他值到布尔类型的值的转换规则" aria-hidden="true">#</a> 19. 其他值到布尔类型的值的转换规则？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ES5 规范 9.2 节中定义了抽象操作 ToBoolean，列举了布尔强制类型转换所有可能出现的结果。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_20-和-的-valueof-和-tostring-的结果是什么" tabindex="-1"><a class="header-anchor" href="#_20-和-的-valueof-和-tostring-的结果是什么" aria-hidden="true">#</a> 20. {} 和 [] 的 valueOf 和 toString 的结果是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{} 的 valueOf 结果为 {} ，toString 的结果为 &quot;[object Object]&quot;

[] 的 valueOf 结果为 [] ，toString 的结果为 &quot;&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_21-什么是假值对象" tabindex="-1"><a class="header-anchor" href="#_21-什么是假值对象" aria-hidden="true">#</a> 21. 什么是假值对象？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>浏览器在某些特定情况下，在常规 JavaScript 语法基础上自己创建了一些外来值，这些就是“假值对象”。假值对象看起来和
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_22-操作符的作用" tabindex="-1"><a class="header-anchor" href="#_22-操作符的作用" aria-hidden="true">#</a> 22. ~ 操作符的作用？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>~ 返回 2 的补码，并且 ~ 会将数字转换为 32 位整数，因此我们可以使用 ~ 来进行取整操作。

~x 大致等同于 -(x+1)。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_23-解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字-它们之间的区别是什么" tabindex="-1"><a class="header-anchor" href="#_23-解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字-它们之间的区别是什么" aria-hidden="true">#</a> 23. 解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字，它们之间的区别是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>解析允许字符串（如 parseInt() ）中含有非数字字符，解析按从左到右的顺序，如果遇到非数字字符就停止。而转换（如 Nu
mber ()）不允许出现非数字字符，否则会失败并返回 NaN。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_24-操作符什么时候用于字符串的拼接" tabindex="-1"><a class="header-anchor" href="#_24-操作符什么时候用于字符串的拼接" aria-hidden="true">#</a> 24. <code>+</code> 操作符什么时候用于字符串的拼接？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>根据 ES5 规范 11.6.1 节，如果某个操作数是字符串或者能够通过以下步骤转换为字符串的话，+ 将进行拼接操作。如果其
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_26-和-操作符的返回值" tabindex="-1"><a class="header-anchor" href="#_26-和-操作符的返回值" aria-hidden="true">#</a> 26. || 和 &amp;&amp; 操作符的返回值？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|| 和 &amp;&amp; 首先会对第一个操作数执行条件判断，如果其不是布尔值就先进行 ToBoolean 强制类型转换，然后再执行条件
判断。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,36),w={href:"https://www.jeffjade.com/2015/08/28/2015-09-02-js-string-compare/",target:"_blank",rel:"noopener noreferrer"},j=t(`<h2 id="_29-如何将字符串转化为数字-例如-12-3b" tabindex="-1"><a class="header-anchor" href="#_29-如何将字符串转化为数字-例如-12-3b" aria-hidden="true">#</a> 29. 如何将字符串转化为数字，例如 &#39;12.3b&#39;?</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）使用 Number() 方法，前提是所包含的字符串不包含不合法字符。
...
<span class="token keyword">function</span> <span class="token function">format2</span><span class="token punctuation">(</span><span class="token parameter">number</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">return</span> number<span class="token punctuation">.</span><span class="token function">toLocaleString</span><span class="token punctuation">(</span><span class="token string">&#39;en&#39;</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),E={href:"http://caibaojian.com/form-regexp.html",target:"_blank",rel:"noopener noreferrer"},M={href:"https://www.jianshu.com/p/1cb5229325a7",target:"_blank",rel:"noopener noreferrer"},O=n("h2",{id:"_32-生成随机数的各种方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_32-生成随机数的各种方法","aria-hidden":"true"},"#"),s(" 32. 生成随机数的各种方法？")],-1),N={href:"http://www.hangge.com/blog/cache/detail_1872.html",target:"_blank",rel:"noopener noreferrer"},A=t(`<h2 id="_33-如何实现数组的随机排序" tabindex="-1"><a class="header-anchor" href="#_33-如何实现数组的随机排序" aria-hidden="true">#</a> 33. 如何实现数组的随机排序？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// （1）使用数组 sort 方法对数组元素随机排序，让 Math.random() 出来的数与 0.5 比较，如果大于就返回 1 交换位置，如果小于就返回 -1，不交换位置。</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),J={href:"https://gaohaoyang.github.io/2016/10/16/shuffle-algorithm/#top",target:"_blank",rel:"noopener noreferrer"},C={href:"https://www.zhihu.com/question/32303195",target:"_blank",rel:"noopener noreferrer"},T={href:"https://www.w3cplus.com/javascript/how-to-randomize-shuffle-a-javascript-array.html",target:"_blank",rel:"noopener noreferrer"},P=t(`<h2 id="_34-javascript-创建对象的几种方式" tabindex="-1"><a class="header-anchor" href="#_34-javascript-创建对象的几种方式" aria-hidden="true">#</a> 34. javascript 创建对象的几种方式？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我们一般使用字面量的形式直接创建对象，但是这种创建方式对于创建大量相似对象的时候，会产生大量的重复代码。但 js
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),L={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8B%E4%BD%9C%E7%94%A8%E5%9F%9F%E9%93%BE.html",target:"_blank",rel:"noopener noreferrer"},V=t(`<h2 id="_38-谈谈-this-对象的理解。" tabindex="-1"><a class="header-anchor" href="#_38-谈谈-this-对象的理解。" aria-hidden="true">#</a> 38. 谈谈 This 对象的理解。</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>this 是执行上下文中的一个属性，它指向最后一次调用这个方法的对象。在实际开发中，this 的指向可以通过四种调用模
式来判断。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>1.第一种是函数调用模式，当一个函数不是一个对象的属性时，直接作为函数来调用时，this 指向全局对象。</p></li><li><p>2.第二种是方法调用模式，如果一个函数作为一个对象的方法来调用时，this 指向这个对象。</p></li><li><p>3.第三种是构造器调用模式，如果一个函数用 new 调用时，函数执行前会新创建一个对象，this 指向这个新创建的对象。</p></li><li><p>4.第四种是 apply 、 call 和 bind 调用模式，这三个方法都可以显示的指定调用函数的 this 指向。其中 apply 方法接收两个参数：一个是 this 绑定的对象，一个是参数数组。call 方法接收的参数，第一个是 this 绑定的对象，后面的其余参数是传入函数执行的参数。也就是说，在使用 call() 方法时，传递给函数的参数必须逐个列举出来。bind 方法通过传入一个对象，返回一个 this 绑定了传入对象的新函数。这个函数的 this 指向除了使用 new 时会被改变，其他情况下都不会改变。</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>这四种方式，使用构造器调用模式的优先级最高，然后是 apply 、 call 和 bind 调用模式，然后是方法调用模式，然后
是函数调用模式。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,4),F={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8Bthis%E8%AF%A6%E8%A7%A3.html",target:"_blank",rel:"noopener noreferrer"},U=t(`<h2 id="_39-eval-是做什么的" tabindex="-1"><a class="header-anchor" href="#_39-eval-是做什么的" aria-hidden="true">#</a> 39. eval 是做什么的？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>它的功能是把对应的字符串解析成 JS 代码并运行。

应该避免使用 eval，不安全，非常耗性能（2次，一次解析成 js 语句，一次执行）。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),z={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/eval",target:"_blank",rel:"noopener noreferrer"},H=t(`<h2 id="_40-什么是-dom-和-bom" tabindex="-1"><a class="header-anchor" href="#_40-什么是-dom-和-bom" aria-hidden="true">#</a> 40. 什么是 DOM 和 BOM？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>DOM 指的是文档对象模型，它指的是把文档当做一个对象来对待，这个对象主要定义了处理网页内容的方法和接口。
...
象的子对象。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),X={href:"https://www.zhihu.com/question/33453164",target:"_blank",rel:"noopener noreferrer"},W={href:"http://www.w3school.com.cn/jsref/dom_obj_window.asp",target:"_blank",rel:"noopener noreferrer"},G={href:"https://www.zhihu.com/question/20724662",target:"_blank",rel:"noopener noreferrer"},$={href:"https://segmentfault.com/a/1190000000654274#articleHeader21",target:"_blank",rel:"noopener noreferrer"},Q=t(`<h2 id="_41-写一个通用的事件侦听器函数。" tabindex="-1"><a class="header-anchor" href="#_41-写一个通用的事件侦听器函数。" aria-hidden="true">#</a> 41. 写一个通用的事件侦听器函数。</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> EventUtils <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Y={href:"https://segmentfault.com/a/1190000006934031#articleHeader6",target:"_blank",rel:"noopener noreferrer"},Z=n("h2",{id:"_42-事件是什么-ie-与火狐的事件机制有什么区别-如何阻止冒泡",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_42-事件是什么-ie-与火狐的事件机制有什么区别-如何阻止冒泡","aria-hidden":"true"},"#"),s(" 42. 事件是什么？IE 与火狐的事件机制有什么区别？ 如何阻止冒泡？")],-1),K=n("ul",null,[n("li",null,[n("p",null,"1.事件是用户操作网页时发生的交互动作，比如 click/move， 事件除了用户触发的动作外，还可以是文档加载，窗口滚动和大小调整。事件被封装成一个 event 对象，包含了该事件发生时的所有相关信息（ event 的属性）以及可以对事件进行的操作（ event 的方法）。")]),n("li",null,[n("p",null,"2.事件处理机制：IE 支持事件冒泡、Firefox 同时支持两种事件模型，也就是：事件冒泡和事件捕获。")]),n("li",null,[n("p",null,"3.event.stopPropagation() 或者 ie 下的方法 event.cancelBubble = true;")])],-1),nn={href:"https://www.cnblogs.com/lvdabao/p/3265870.html",target:"_blank",rel:"noopener noreferrer"},sn={href:"https://blog.csdn.net/wuseyukui/article/details/13771493",target:"_blank",rel:"noopener noreferrer"},an=t(`<h2 id="_43-三种事件模型是什么" tabindex="-1"><a class="header-anchor" href="#_43-三种事件模型是什么" aria-hidden="true">#</a> 43. 三种事件模型是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>事件是用户操作网页时发生的交互动作或者网页本身的一些操作，现代浏览器一共有三种事件模型。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),en={href:"https://blog.csdn.net/u013217071/article/details/77613706",target:"_blank",rel:"noopener noreferrer"},tn=t(`<h2 id="_44-事件委托是什么" tabindex="-1"><a class="header-anchor" href="#_44-事件委托是什么" aria-hidden="true">#</a> 44. 事件委托是什么？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>事件委托本质上是利用了浏览器事件冒泡的机制。因为事件在冒泡过程中会上传到父节点，并且父节点可以通过事件对象获取到
目标节点，因此可以把子节点的监听函数定义在父节点上，由父节点的监听函数统一处理多个子元素的事件，这种方式称为事件代理。

使用事件代理我们可以不必要为每一个子元素都绑定一个监听事件，这样减少了内存上的消耗。并且使用事件代理我们还可以实现事件的动态绑定，比如说新增了一个子节点，我们并不需要单独地为它添加一个监听事件，它所发生的事件会交给父元素中的监听函数来处理。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ln={href:"https://zhuanlan.zhihu.com/p/26536815",target:"_blank",rel:"noopener noreferrer"},on=t(`<h2 id="_45-1-2-3-map-parseint-答案是多少" tabindex="-1"><a class="header-anchor" href="#_45-1-2-3-map-parseint-答案是多少" aria-hidden="true">#</a> 45. [&quot;1&quot;, &quot;2&quot;, &quot;3&quot;].map(parseInt) 答案是多少？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>parseInt() 函数能解析一个字符串，并返回一个整数，需要两个参数 (val, radix)，其中 radix 表示要解析的数字的基数。（该值介于 2 ~ 36 之间，并且字符串中的数字不能大于 radix 才能正确返回数字结果值）。


此处 map 传了 3 个参数 (element, index, array)，默认第三个参数被忽略掉，因此三次传入的参数分别为 &quot;1-0&quot;, &quot;2-1&quot;, &quot;3-2&quot;

因为字符串的值不能大于基数，因此后面两次调用均失败，返回 NaN ，第一次基数为 0 ，按十进制解析返回 1。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),pn={href:"https://blog.csdn.net/justjavac/article/details/19473199",target:"_blank",rel:"noopener noreferrer"},cn=t(`<h2 id="_46-什么是闭包-为什么要用它" tabindex="-1"><a class="header-anchor" href="#_46-什么是闭包-为什么要用它" aria-hidden="true">#</a> 46. 什么是闭包，为什么要用它？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>闭包是指有权访问另一个函数作用域中变量的函数，创建闭包的最常见的方式就是在一个函数内创建另一个函数，创建的函数可以
访问到当前函数的局部变量。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),rn={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8B%E9%97%AD%E5%8C%85.html",target:"_blank",rel:"noopener noreferrer"},un=t(`<h2 id="_47-javascript-代码中的-use-strict-是什么意思-使用它区别是什么" tabindex="-1"><a class="header-anchor" href="#_47-javascript-代码中的-use-strict-是什么意思-使用它区别是什么" aria-hidden="true">#</a> 47. javascript 代码中的 &quot;use strict&quot;; 是什么意思 ? 使用它区别是什么？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>use strict 是一种 ECMAscript5 添加的（严格）运行模式，这种模式使得 Javascript 在更严格的条件下运行。

设立&quot;严格模式&quot;的目的，主要有以下几个：
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>消除 Javascript 语法的一些不合理、不严谨之处，减少一些怪异行为;</li><li>消除代码运行的一些不安全之处，保证代码运行的安全；</li><li>提高编译器效率，增加运行速度；</li><li>为未来新版本的 Javascript 做好铺垫。</li></ul><p>区别：</p><ul><li>1.禁止使用 with 语句。</li><li>2.禁止 this 关键字指向全局对象。</li><li>3.对象不能有重名的属性。</li></ul><p>回答：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>use strict 指的是严格运行模式，在这种模式对 js 的使用添加了一些限制。比如说禁止 this 指向全局对象，还有禁止使
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),dn={href:"http://www.ruanyifeng.com/blog/2013/01/javascript_strict_mode.html",target:"_blank",rel:"noopener noreferrer"},vn=t(`<h2 id="_48-如何判断一个对象是否属于某个类" tabindex="-1"><a class="header-anchor" href="#_48-如何判断一个对象是否属于某个类" aria-hidden="true">#</a> 48. 如何判断一个对象是否属于某个类？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>第一种方式是使用 instanceof 运算符来判断构造函数的 prototype 属性是否出现在对象的原型链中的任何位置。
...
[[Class]] 属性来进行判断。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),mn={href:"https://blog.csdn.net/haitunmin/article/details/78418522",target:"_blank",rel:"noopener noreferrer"},kn=t(`<h2 id="_49-instanceof-的作用" tabindex="-1"><a class="header-anchor" href="#_49-instanceof-的作用" aria-hidden="true">#</a> 49. instanceof 的作用？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// instanceof 运算符用于判断构造函数的 prototype 属性是否出现在对象的原型链中的任何位置。</span>
...
<span class="token keyword">function</span> <span class="token function">myInstanceof</span><span class="token punctuation">(</span><span class="token parameter">left<span class="token punctuation">,</span> right</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),bn={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/instanceof",target:"_blank",rel:"noopener noreferrer"},hn=t(`<h2 id="_50-new-操作符具体干了什么呢-如何实现" tabindex="-1"><a class="header-anchor" href="#_50-new-操作符具体干了什么呢-如何实现" aria-hidden="true">#</a> 50. new 操作符具体干了什么呢？如何实现？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// （1）首先创建了一个新的空对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),gn={href:"https://segmentfault.com/a/1190000008576048",target:"_blank",rel:"noopener noreferrer"},fn={href:"https://github.com/mqyqingfeng/Blog/issues/13",target:"_blank",rel:"noopener noreferrer"},_n=t(`<h2 id="_51-javascript-中-有一个函数-执行时对象查找时-永远不会去查找原型-这个函数是" tabindex="-1"><a class="header-anchor" href="#_51-javascript-中-有一个函数-执行时对象查找时-永远不会去查找原型-这个函数是" aria-hidden="true">#</a> 51. Javascript 中，有一个函数，执行时对象查找时，永远不会去查找原型，这个函数是？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>hasOwnProperty

所有继承了 Object 的对象都会继承到 hasOwnProperty 方法。这个方法可以用来检测一个对象是否含有特定的自身属性，和
in 运算符不同，该方法会忽略掉那些从原型链上继承到的属性。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),xn={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/hasOwnProperty",target:"_blank",rel:"noopener noreferrer"},yn=t(`<h2 id="_52-对于-json-的了解" tabindex="-1"><a class="header-anchor" href="#_52-对于-json-的了解" aria-hidden="true">#</a> 52. 对于 JSON 的了解？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>JSON 是一种数据交换格式，基于文本，优于轻量，用于交换数据。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),wn={href:"https://my.oschina.net/u/3284240/blog/874368",target:"_blank",rel:"noopener noreferrer"},jn=t(`<h2 id="_53-foreach-call-function-a-a-style-outline-1px-solid-math-random-1-24-tostring-16-能解释一下这段代码的意思吗" tabindex="-1"><a class="header-anchor" href="#_53-foreach-call-function-a-a-style-outline-1px-solid-math-random-1-24-tostring-16-能解释一下这段代码的意思吗" aria-hidden="true">#</a> 53. <code>[].forEach.call($$(&quot;*&quot;),function(a){a.style.outline=&quot;1px solid #&quot;+(~~(Math.random()*(1&lt;&lt;24))).toString(16)})</code> 能解释一下这段代码的意思吗？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）选取页面所有 DOM 元素。在浏览器的控制台中可以使用$$()方法来获取页面中相应的元素，这是现代浏览器提供的一个命令行 API 相当于 document.querySelectorAll 方法。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Sn={href:"https://2008winstar.iteye.com/blog/2128290",target:"_blank",rel:"noopener noreferrer"},qn=t(`<h2 id="_54-js-延迟加载的方式有哪些" tabindex="-1"><a class="header-anchor" href="#_54-js-延迟加载的方式有哪些" aria-hidden="true">#</a> 54. js 延迟加载的方式有哪些？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>js 延迟加载，也就是等页面加载完成之后再加载 JavaScript 文件。 js 延迟加载有助于提高页面加载速度。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),En={href:"https://blog.csdn.net/meijory/article/details/76389762",target:"_blank",rel:"noopener noreferrer"},Mn={href:"http://www.w3school.com.cn/html5/att_script_async.asp",target:"_blank",rel:"noopener noreferrer"},On=n("code",null,"<script>",-1),Nn=n("code",null,"async",-1),An=t(`<h2 id="_55-ajax-是什么-如何创建一个-ajax" tabindex="-1"><a class="header-anchor" href="#_55-ajax-是什么-如何创建一个-ajax" aria-hidden="true">#</a> 55. Ajax 是什么? 如何创建一个 Ajax？</h2><p>相关知识点：</p><p>2005 年 2 月，AJAX 这个词第一次正式提出，它是 Asynchronous JavaScript and XML 的缩写，指的是通过 JavaScript 的 异步通信，从服务器获取 XML 文档从中提取数据，再更新当前网页的对应部分，而不用刷新整个网页。</p><p>具体来说，AJAX 包括以下几个步骤。</p><ul><li>1.创建 XMLHttpRequest 对象，也就是创建一个异步调用对象</li><li>2.创建一个新的 HTTP 请求，并指定该 HTTP 请求的方法、URL 及验证信息</li><li>3.设置响应 HTTP 请求状态变化的函数</li><li>4.发送 HTTP 请求</li><li>5.获取异步调用返回的数据</li><li>6.使用 JavaScript 和 DOM 实现局部刷新</li></ul><p>一般实现：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token constant">SERVER_URL</span> <span class="token operator">=</span> <span class="token string">&quot;/server&quot;</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),Jn={href:"https://wangdoc.com/javascript/bom/xmlhttprequest.html",target:"_blank",rel:"noopener noreferrer"},Cn={href:"https://juejin.im/post/5acde23c5188255cb32e7e76",target:"_blank",rel:"noopener noreferrer"},Tn={href:"https://juejin.im/post/5c160937f265da61180199b2",target:"_blank",rel:"noopener noreferrer"},Pn={href:"https://segmentfault.com/a/1190000003810652",target:"_blank",rel:"noopener noreferrer"},Rn=t(`<h2 id="_56-谈一谈浏览器的缓存机制" tabindex="-1"><a class="header-anchor" href="#_56-谈一谈浏览器的缓存机制" aria-hidden="true">#</a> 56. 谈一谈浏览器的缓存机制？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>浏览器的缓存机制指的是通过在一段时间内保留已接收到的 web 资源的一个副本，如果在资源的有效时间内，发起了对这个资源的再一次请求，那么浏览器会直接使用缓存的副本，而不是向服务器发起请求。使用 web 缓存可以有效地提高页面的打开速度，减少不必要的网络带宽的消耗。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),In={href:"https://segmentfault.com/a/1190000012573337",target:"_blank",rel:"noopener noreferrer"},Dn={href:"https://juejin.im/post/5b9346dcf265da0aac6fbe57#heading-3",target:"_blank",rel:"noopener noreferrer"},Bn={href:"https://www.web-tinker.com/article/21221.html",target:"_blank",rel:"noopener noreferrer"},Ln={href:"https://juejin.im/post/5c2d6c9ae51d450cf4195a08",target:"_blank",rel:"noopener noreferrer"},Vn=t('<h2 id="_57-ajax-解决浏览器缓存问题" tabindex="-1"><a class="header-anchor" href="#_57-ajax-解决浏览器缓存问题" aria-hidden="true">#</a> 57. Ajax 解决浏览器缓存问题？</h2><ul><li><p>1.在 ajax 发送请求前加上 anyAjaxObj.setRequestHeader(&quot;If-Modified-Since&quot;,&quot;0&quot;)。</p></li><li><p>2.在 ajax 发送请求前加上 anyAjaxObj.setRequestHeader(&quot;Cache-Control&quot;,&quot;no-cache&quot;)。</p></li><li><p>3.在 URL 后面加上一个随机数： &quot;fresh=&quot; + Math.random();。</p></li><li><p>4.在 URL 后面加上时间戳：&quot;nowtime=&quot; + new Date().getTime();。</p></li><li><p>5.如果是使用 jQuery，直接这样就可以了$.ajaxSetup({cache:false})。这样页面的所有 ajax 都会执行这条语句就是不需要保存缓存记录。</p></li></ul>',2),Fn={href:"https://www.cnblogs.com/cwzqianduan/p/8632009.html",target:"_blank",rel:"noopener noreferrer"},Un={href:"https://segmentfault.com/a/1190000012573337",target:"_blank",rel:"noopener noreferrer"},zn=t(`<h2 id="_58-同步和异步的区别" tabindex="-1"><a class="header-anchor" href="#_58-同步和异步的区别" aria-hidden="true">#</a> 58. 同步和异步的区别？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>同步，可以理解为在执行完一个函数或方法之后，一直等待系统返回值或消息，这时程序是处于阻塞的，只有接收到返回的值或消息后才往下执行其他的命令。  

异步，执行完函数或方法后，不必阻塞性地等待返回值或消息，只需要向系统委托一个异步过程，那么当系统接收到返回值或消息时，系统会自动触发委托的异步过程，从而完成一个完整的流程。 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>回答：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>同步指的是当一个进程在执行某个请求的时候，如果这个请求需要等待一段时间才能返回，那么这个进程会一直等待下去，直到消息返
回为止再继续向下执行。

异步指的是当一个进程在执行某个请求的时候，如果这个请求需要等待一段时间才能返回，这个时候进程会继续往下执行，不会阻塞等
待消息的返回，当消息返回时系统再通知进程进行处理。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Hn={href:"https://blog.csdn.net/tennysonsky/article/details/45111623",target:"_blank",rel:"noopener noreferrer"},Xn=t(`<h2 id="_59-什么是浏览器的同源政策" tabindex="-1"><a class="header-anchor" href="#_59-什么是浏览器的同源政策" aria-hidden="true">#</a> 59. 什么是浏览器的同源政策？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我对浏览器的同源政策的理解是，一个域下的 js 脚本在未经允许的情况下，不能够访问另一个域的内容。这里的同源的指的是两个
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),Wn={href:"https://segmentfault.com/a/1190000011145364",target:"_blank",rel:"noopener noreferrer"},Gn={href:"http://www.ruanyifeng.com/blog/2016/04/same-origin-policy.html",target:"_blank",rel:"noopener noreferrer"},$n={href:"https://juejin.im/entry/59feae9df265da43094488f6",target:"_blank",rel:"noopener noreferrer"},Qn={href:"https://www.zhihu.com/question/31592553",target:"_blank",rel:"noopener noreferrer"},Yn=n("h2",{id:"_61-服务器代理转发时-该如何处理-cookie",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_61-服务器代理转发时-该如何处理-cookie","aria-hidden":"true"},"#"),s(" 61. 服务器代理转发时，该如何处理 cookie？")],-1),Zn={href:"https://www.jianshu.com/p/5eab0f83e3b4",target:"_blank",rel:"noopener noreferrer"},Kn=t(`<h2 id="_62-简单谈一下-cookie" tabindex="-1"><a class="header-anchor" href="#_62-简单谈一下-cookie" aria-hidden="true">#</a> 62. 简单谈一下 cookie ？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我的理解是 cookie 是服务器提供的一种用于维护会话状态信息的数据，通过服务器发送到浏览器，浏览器保存在本地，当下一次有同源的请求时，将保存的 cookie 值添加到请求头部，发送给服务端。这可以用来实现记录用户登录状态等功能。cookie 一般可以存储 4k 大小的数据，并且只能够被同源的网页所共享访问。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ns={href:"https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Cookies",target:"_blank",rel:"noopener noreferrer"},ss={href:"https://segmentfault.com/a/1190000004556040",target:"_blank",rel:"noopener noreferrer"},as=t(`<h2 id="_63-模块化开发怎么做" tabindex="-1"><a class="header-anchor" href="#_63-模块化开发怎么做" aria-hidden="true">#</a> 63. 模块化开发怎么做？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我对模块的理解是，一个模块是实现一个特定功能的一组方法。在最开始的时候，js 只实现一些简单的功能，所以并没有模块的概念
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),es={href:"https://juejin.im/post/5ab378c46fb9a028ce7b824f",target:"_blank",rel:"noopener noreferrer"},ts={href:"http://www.ruanyifeng.com/blog/2012/10/javascript_module.html",target:"_blank",rel:"noopener noreferrer"},is={href:"https://juejin.im/post/5aaa37c8f265da23945f365c",target:"_blank",rel:"noopener noreferrer"},ls={href:"http://es6.ruanyifeng.com/#docs/module",target:"_blank",rel:"noopener noreferrer"},os=t(`<h2 id="_64-js-的几种模块规范" tabindex="-1"><a class="header-anchor" href="#_64-js-的几种模块规范" aria-hidden="true">#</a> 64. js 的几种模块规范？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>js 中现在比较成熟的有四种模块加载方案。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_65-amd-和-cmd-规范的区别" tabindex="-1"><a class="header-anchor" href="#_65-amd-和-cmd-规范的区别" aria-hidden="true">#</a> 65. AMD 和 CMD 规范的区别？</h2><p>它们之间的主要区别有两个方面。</p><p>（1）第一个方面是在模块定义时对依赖的处理不同。AMD 推崇依赖前置，在定义模块的时候就要声明其依赖的模块。而 CMD 推崇 就近依赖，只有在用到某个模块的时候再去 require。</p><p>（2）第二个方面是对依赖模块的执行时机处理不同。首先 AMD 和 CMD 对于模块的加载方式都是异步加载，不过它们的区别在于 模块的执行时机，AMD 在依赖模块加载完成后就直接执行依赖模块，依赖模块的执行顺序和我们书写的顺序不一定一致。而 CMD 在依赖模块加载完成后并不执行，只是下载而已，等到所有的依赖模块都加载好后，进入回调函数逻辑，遇到 require 语句 的时候才执行对应的模块，这样模块的执行顺序就和我们书写的顺序保持一致了。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// CMD</span>
...
<span class="token function">define</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&quot;./a&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;./b&quot;</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">a<span class="token punctuation">,</span> b</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// ...</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),ps={href:"https://juejin.im/post/5a422b036fb9a045211ef789",target:"_blank",rel:"noopener noreferrer"},cs=t(`<h2 id="_66-es6-模块与-commonjs-模块、amd、cmd-的差异。" tabindex="-1"><a class="header-anchor" href="#_66-es6-模块与-commonjs-模块、amd、cmd-的差异。" aria-hidden="true">#</a> 66. ES6 模块与 CommonJS 模块、AMD、CMD 的差异。</h2><ul><li><p>1.CommonJS 模块输出的是一个值的拷贝，ES6 模块输出的是值的引用。CommonJS 模块输出的是值的拷贝，也就是说，一旦输出一个值，模块内部的变化就影响不到这个值。ES6 模块的运行机制与 CommonJS 不一样。JS 引擎对脚本静态分析的时候，遇到模块加载命令 import，就会生成一个只读引用。等到脚本真正执行时，再根据这个只读引用，到被加载的那个模块里面去取值。</p></li><li><p>2.CommonJS 模块是运行时加载，ES6 模块是编译时输出接口。CommonJS 模块就是对象，即在输入时是先加载整个模块，生成一个对象，然后再从这个对象上面读取方法，这种加载称为“运行时加载”。而 ES6 模块不是对象，它的对外接口只是一种静态定义，在代码静态解析阶段就会生成。</p></li></ul><h2 id="_67-requirejs-的核心原理是什么-如何动态加载的-如何避免多次加载的-如何-缓存的" tabindex="-1"><a class="header-anchor" href="#_67-requirejs-的核心原理是什么-如何动态加载的-如何避免多次加载的-如何-缓存的" aria-hidden="true">#</a> 67. requireJS 的核心原理是什么？（如何动态加载的？如何避免多次加载的？如何 缓存的？）</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>require.js 的核心原理是通过动态创建 script 脚本来异步引入模块，然后对每个脚本的 load 事件进行监听，如果每个脚本都加载完成了，再调用回调函数。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,4),rs={href:"https://github.com/HRFE/blog/issues/10",target:"_blank",rel:"noopener noreferrer"},us={href:"https://zhuanlan.zhihu.com/p/55039478",target:"_blank",rel:"noopener noreferrer"},ds={href:"https://www.cnblogs.com/dong-xu/p/7160919.html",target:"_blank",rel:"noopener noreferrer"},vs={href:"https://www.jianshu.com/p/5a39535909e4",target:"_blank",rel:"noopener noreferrer"},ms=n("h2",{id:"_68-js-模块加载器的轮子怎么造-也就是如何实现一个模块加载器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_68-js-模块加载器的轮子怎么造-也就是如何实现一个模块加载器","aria-hidden":"true"},"#"),s(" 68. JS 模块加载器的轮子怎么造，也就是如何实现一个模块加载器？")],-1),ks={href:"https://www.zhihu.com/question/21157540",target:"_blank",rel:"noopener noreferrer"},bs=t(`<h2 id="_69-ecmascript6-怎么写-class-为什么会出现-class-这种东西" tabindex="-1"><a class="header-anchor" href="#_69-ecmascript6-怎么写-class-为什么会出现-class-这种东西" aria-hidden="true">#</a> 69. ECMAScript6 怎么写 class，为什么会出现 class 这种东西?</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在我看来 ES6 新添加的 class 只是为了补充 js 中缺少的一些面向对象语言的特性，但本质上来说它只是一种语法糖，不是一个新的东西，其背后还是原型继承的思想。通过加入 class 可以有利于我们更好的组织代码。

在 class 中添加的方法，其实是添加在类的原型上的。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),hs={href:"https://www.zhihu.com/question/29789315",target:"_blank",rel:"noopener noreferrer"},gs={href:"http://es6.ruanyifeng.com/#docs/class",target:"_blank",rel:"noopener noreferrer"},fs=t(`<h2 id="_70-documen-write-和-innerhtml-的区别" tabindex="-1"><a class="header-anchor" href="#_70-documen-write-和-innerhtml-的区别" aria-hidden="true">#</a> 70. documen.write 和 innerHTML 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>document.write 的内容会代替整个文档内容，会重写整个页面。

innerHTML 的内容只是替代指定元素的内容，只会重写页面中的部分内容。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),_s={href:"https://www.nowcoder.com/questionTerminal/2c5d8105b2694d85b06eff85e871cf50",target:"_blank",rel:"noopener noreferrer"},xs=t(`<h2 id="_71-dom-操作——怎样添加、移除、移动、复制、创建和查找节点" tabindex="-1"><a class="header-anchor" href="#_71-dom-操作——怎样添加、移除、移动、复制、创建和查找节点" aria-hidden="true">#</a> 71. DOM 操作——怎样添加、移除、移动、复制、创建和查找节点？</h2><p>（1）创建新节点</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token function">createDocumentFragment</span><span class="token punctuation">(</span>node<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）添加、移除、替换、插入</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token function">appendChild</span><span class="token punctuation">(</span>node<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),ys={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Document_Object_Model/Introduction#DOM_interfaces",target:"_blank",rel:"noopener noreferrer"},ws={href:"https://harttle.land/2015/10/01/javascript-dom-api.html",target:"_blank",rel:"noopener noreferrer"},js={href:"https://microzz.com/2017/04/06/jsdom/",target:"_blank",rel:"noopener noreferrer"},Ss=t(`<h2 id="_72-innerhtml-与-outerhtml-的区别" tabindex="-1"><a class="header-anchor" href="#_72-innerhtml-与-outerhtml-的区别" aria-hidden="true">#</a> 72. innerHTML 与 outerHTML 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>对于这样一个 HTML 元素：&lt;div&gt;content&lt;br/&gt;&lt;/div&gt;。

innerHTML：内部 HTML，content&lt;br/&gt;；
outerHTML：外部 HTML，&lt;div&gt;content&lt;br/&gt;&lt;/div&gt;；
innerText：内部文本，content ；
outerText：内部文本，content ；
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_73-call-和-apply-的区别" tabindex="-1"><a class="header-anchor" href="#_73-call-和-apply-的区别" aria-hidden="true">#</a> 73. .call() 和 .apply() 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>它们的作用一模一样，区别仅在于传入参数的形式的不同。

apply 接受两个参数，第一个参数指定了函数体内 this 对象的指向，第二个参数为一个带下标的集合，这个集合可以为数组，也可以为类数组，apply 方法把这个集合中的元素作为参数传递给被调用的函数。

call 传入的参数数量不固定，跟 apply 相同的是，第一个参数也是代表函数体内的 this 指向，从第二个参数开始往后，每个参数被依次传入函数。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),qs={href:"https://juejin.im/entry/58d0a7b22f301e007e5a15ae",target:"_blank",rel:"noopener noreferrer"},Es=t(`<h2 id="_74-javascript-类数组对象的定义" tabindex="-1"><a class="header-anchor" href="#_74-javascript-类数组对象的定义" aria-hidden="true">#</a> 74. JavaScript 类数组对象的定义？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>一个拥有 length 属性和若干索引属性的对象就可以被称为类数组对象，类数组对象和数组类似，但是不能调用数组的方法。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11),Ms={href:"https://github.com/mqyqingfeng/Blog/issues/14",target:"_blank",rel:"noopener noreferrer"},Os={href:"https://segmentfault.com/a/1190000000415572",target:"_blank",rel:"noopener noreferrer"},Ns={href:"https://blog.lxxyx.cn/2016/05/07/%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3JavaScript%E7%B1%BB%E6%95%B0%E7%BB%84/",target:"_blank",rel:"noopener noreferrer"},As=t(`<h2 id="_75-数组和对象有哪些原生方法-列举一下" tabindex="-1"><a class="header-anchor" href="#_75-数组和对象有哪些原生方法-列举一下" aria-hidden="true">#</a> 75. 数组和对象有哪些原生方法，列举一下？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>数组和字符串的转换方法：toString()、toLocalString()、join() 其中 join() 方法可以指定转换为字符串时的分隔符。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Js={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8BArray%E8%AF%A6%E8%A7%A3.html",target:"_blank",rel:"noopener noreferrer"},Cs=t(`<h2 id="_76-数组的-fill-方法" tabindex="-1"><a class="header-anchor" href="#_76-数组的-fill-方法" aria-hidden="true">#</a> 76. 数组的 fill 方法？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>fill() 方法用一个固定值填充一个数组中从起始索引到终止索引内的全部元素。不包括终止索引。
fill 方法接受三个参数 value，start 以及 end，start 和 end 参数是可选的，其默认值分别为 0 和 this 对象的 length 属性值。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ts={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/fill",target:"_blank",rel:"noopener noreferrer"},Ps=t(`<h2 id="_77-的长度" tabindex="-1"><a class="header-anchor" href="#_77-的长度" aria-hidden="true">#</a> 77. [,,,] 的长度？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>尾后逗号 （有时叫做“终止逗号”）在向 JavaScript 代码添加元素、参数、属性时十分有用。如果你想要添加新的属性，并且上一行已经使用了尾后逗号，你可以仅仅添加新的一行，而不需要修改上一行。这使得版本控制更加清晰，以及代码维护麻烦更少。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ds={href:"http://cavszhouyou.top/JavaScript%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E4%B9%8B%E5%8F%98%E9%87%8F%E5%AF%B9%E8%B1%A1.html",target:"_blank",rel:"noopener noreferrer"},Bs=n("h2",{id:"_79-如何编写高性能的-javascript",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_79-如何编写高性能的-javascript","aria-hidden":"true"},"#"),s(" 79. 如何编写高性能的 Javascript ？")],-1),Ls=n("ul",null,[n("li",null,"1.使用位运算代替一些简单的四则运算。"),n("li",null,"2.避免使用过深的嵌套循环。"),n("li",null,"3.不要使用未定义的变量。"),n("li",null,"4.当需要多次访问数组长度时，可以用变量保存起来，避免每次都会去进行属性查找。")],-1),Vs={href:"https://zhuanlan.zhihu.com/p/34780474",target:"_blank",rel:"noopener noreferrer"},Fs=t(`<h2 id="_80-简单介绍一下-v8-引擎的垃圾回收机制" tabindex="-1"><a class="header-anchor" href="#_80-简单介绍一下-v8-引擎的垃圾回收机制" aria-hidden="true">#</a> 80. 简单介绍一下 V8 引擎的垃圾回收机制</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>v8 的垃圾回收机制基于分代回收机制，这个机制又基于世代假说，这个假说有两个特点，一是新生的对象容易早死，另一个是不死的对象会活得更久。基于这个假说，v8 引擎将内存分为了新生代和老生代。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Us={href:"https://www.jianshu.com/p/b8ed21e8a4fb",target:"_blank",rel:"noopener noreferrer"},zs={href:"https://zhuanlan.zhihu.com/p/23992332",target:"_blank",rel:"noopener noreferrer"},Hs=t(`<h2 id="_81-哪些操作会造成内存泄漏" tabindex="-1"><a class="header-anchor" href="#_81-哪些操作会造成内存泄漏" aria-hidden="true">#</a> 81. 哪些操作会造成内存泄漏？</h2><p>相关知识点：</p><ul><li>1.意外的全局变量</li><li>2.被遗忘的计时器或回调函数</li><li>3.脱离 DOM 的引用</li><li>4.闭包</li></ul><p>回答：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>第一种情况是我们由于使用未声明的变量，而意外的创建了一个全局变量，而使这个变量一直留在内存中无法被回收。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Xs={href:"http://www.ruanyifeng.com/blog/2017/04/memory-leak.html",target:"_blank",rel:"noopener noreferrer"},Ws={href:"https://jinlong.github.io/2016/05/01/4-Types-of-Memory-Leaks-in-JavaScript-and-How-to-Get-Rid-Of-Them/",target:"_blank",rel:"noopener noreferrer"},Gs={href:"https://juejin.im/entry/5a64366c6fb9a01c9332c706",target:"_blank",rel:"noopener noreferrer"},$s={href:"https://segmentfault.com/a/1190000008901861",target:"_blank",rel:"noopener noreferrer"},Qs=t(`<h2 id="_82-需求-实现一个页面操作不会整页刷新的网站-并且能在浏览器前进、后退时正确响应。给出你的技术实现方案" tabindex="-1"><a class="header-anchor" href="#_82-需求-实现一个页面操作不会整页刷新的网站-并且能在浏览器前进、后退时正确响应。给出你的技术实现方案" aria-hidden="true">#</a> 82. 需求：实现一个页面操作不会整页刷新的网站，并且能在浏览器前进、后退时正确响应。给出你的技术实现方案？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>通过使用 pushState + ajax 实现浏览器无刷新前进后退，当一次 ajax 调用成功后我们将一条 state 记录加入到 history
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ys={href:"http://blog.chenxu.me/post/detail?id=ed4f0732-897f-48e4-9d4f-821e82f17fad",target:"_blank",rel:"noopener noreferrer"},Zs={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/History_API",target:"_blank",rel:"noopener noreferrer"},Ks=t(`<h2 id="_83-如何判断当前脚本运行在浏览器还是-node-环境中-阿里" tabindex="-1"><a class="header-anchor" href="#_83-如何判断当前脚本运行在浏览器还是-node-环境中-阿里" aria-hidden="true">#</a> 83. 如何判断当前脚本运行在浏览器还是 node 环境中？（阿里）</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>typeof window === &#39;undefined&#39; ? &#39;node&#39; : &#39;browser&#39;;

通过判断当前环境的 window 对象类型是否为 undefined，如果是undefined，则说明当前脚本运行在node环境，否则说明运行在window环境。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_84-把-script-标签放在页面的最底部的-body-封闭之前和封闭之后有什么区别-浏览器会如何解析它们" tabindex="-1"><a class="header-anchor" href="#_84-把-script-标签放在页面的最底部的-body-封闭之前和封闭之后有什么区别-浏览器会如何解析它们" aria-hidden="true">#</a> 84. 把 script 标签放在页面的最底部的 body 封闭之前和封闭之后有什么区别？浏览器会如何解析它们？</h2>`,3),na={href:"https://www.zhihu.com/question/20027966",target:"_blank",rel:"noopener noreferrer"},sa={href:"https://zhuanlan.zhihu.com/p/30558018",target:"_blank",rel:"noopener noreferrer"},aa=t(`<h2 id="_85-移动端的点击事件的有延迟-时间是多久-为什么会有-怎么解决这个延时" tabindex="-1"><a class="header-anchor" href="#_85-移动端的点击事件的有延迟-时间是多久-为什么会有-怎么解决这个延时" aria-hidden="true">#</a> 85. 移动端的点击事件的有延迟，时间是多久，为什么会有？ 怎么解决这个延时？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>移动端点击有 300ms 的延迟是因为移动端会有双击缩放的这个操作，因此浏览器在 click 之后要等待 300ms，看用户有没有下一次点击，来判断这次操作是不是双击。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ia={href:"https://segmentfault.com/q/1010000005336260",target:"_blank",rel:"noopener noreferrer"},la={href:"https://github.com/kaola-fed/blog/issues/137",target:"_blank",rel:"noopener noreferrer"},oa={href:"https://www.zhihu.com/question/53064386",target:"_blank",rel:"noopener noreferrer"},pa=n("h2",{id:"_87-如何测试前端代码么-知道-bdd-tdd-unit-test-么-知道怎么测试你的前端工程么-mocha-sinon-jasmin-qunit",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_87-如何测试前端代码么-知道-bdd-tdd-unit-test-么-知道怎么测试你的前端工程么-mocha-sinon-jasmin-qunit","aria-hidden":"true"},"#"),s(" 87. 如何测试前端代码么？ 知道 BDD, TDD, Unit Test 么？ 知道怎么测试你的前端工程么(mocha, sinon, jasmin, qUnit..)？")],-1),ca={href:"https://juejin.im/post/5b2da89cf265da597f1c7cab",target:"_blank",rel:"noopener noreferrer"},ra=t(`<h2 id="_88-检测浏览器版本版本有哪些方式" tabindex="-1"><a class="header-anchor" href="#_88-检测浏览器版本版本有哪些方式" aria-hidden="true">#</a> 88. 检测浏览器版本版本有哪些方式？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>检测浏览器版本一共有两种方式：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ua={href:"https://www.jianshu.com/p/d99f4ca385ac",target:"_blank",rel:"noopener noreferrer"},da=t(`<h2 id="_89-什么是-polyfill" tabindex="-1"><a class="header-anchor" href="#_89-什么是-polyfill" aria-hidden="true">#</a> 89. 什么是 Polyfill ？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Polyfill 指的是用于实现浏览器并不支持的原生 API 的代码。

比如说 querySelectorAll 是很多现代浏览器都支持的原生 Web API，但是有些古老的浏览器并不支持，那么假设有人写了一段代码来实现这个功能使这些浏览器也支持了这个功能，那么这就可以成为一个 Polyfill。

一个 shim 是一个库，有自己的 API，而不是单纯实现原生不支持的 API。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),va={href:"https://segmentfault.com/a/1190000002593432",target:"_blank",rel:"noopener noreferrer"},ma={href:"https://juejin.im/post/5a579bc7f265da3e38496ba1",target:"_blank",rel:"noopener noreferrer"},ka=t(`<h2 id="_90-使用-js-实现获取文件扩展名" tabindex="-1"><a class="header-anchor" href="#_90-使用-js-实现获取文件扩展名" aria-hidden="true">#</a> 90. 使用 JS 实现获取文件扩展名？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// String.lastIndexOf() 方法返回指定值（本例中的&#39;.&#39;）在调用该方法的字符串中最后出现的位置，如果没找到则返回 -1。</span>

<span class="token comment">// 对于 &#39;filename&#39; 和 &#39;.hiddenfile&#39; ，lastIndexOf 的返回值分别为 0 和 -1 无符号右移操作符(&gt;&gt;&gt;) 将 -1 转换为 4294967295 ，将 -2 转换为 4294967294 ，这个方法可以保证边缘情况时文件名不变。</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ba={href:"https://segmentfault.com/a/1190000004993946",target:"_blank",rel:"noopener noreferrer"},ha=t(`<h2 id="_91-介绍一下-js-的节流与防抖" tabindex="-1"><a class="header-anchor" href="#_91-介绍一下-js-的节流与防抖" aria-hidden="true">#</a> 91. 介绍一下 js 的节流与防抖？</h2><p>相关知识点：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 函数防抖： 在事件被触发 n 秒后再执行回调，如果在这 n 秒内事件又被触发，则重新计时。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),ga={href:"https://juejin.im/post/5a35ed25f265da431d3cc1b1",target:"_blank",rel:"noopener noreferrer"},fa={href:"https://juejin.im/post/5aa60b0e518825556b6c6d1a",target:"_blank",rel:"noopener noreferrer"},_a={href:"https://juejin.im/entry/5b1d2d54f265da6e2545bfa4",target:"_blank",rel:"noopener noreferrer"},xa=t(`<h2 id="_92-object-is-与原来的比较操作符-、-的区别" tabindex="-1"><a class="header-anchor" href="#_92-object-is-与原来的比较操作符-、-的区别" aria-hidden="true">#</a> 92. Object.is() 与原来的比较操作符 “===”、“==” 的区别？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>两等号判等，会在比较时进行类型转换。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_93-escape-encodeuri-encodeuricomponent-有什么区别" tabindex="-1"><a class="header-anchor" href="#_93-escape-encodeuri-encodeuricomponent-有什么区别" aria-hidden="true">#</a> 93. escape,encodeURI,encodeURIComponent 有什么区别？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>escape 和 encodeURI 都属于 Percent-encoding，基本功能都是把 URI 非法字符转化成合法字符，转化后形式类似「%*」。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),ya={href:"https://www.zhihu.com/question/21861899",target:"_blank",rel:"noopener noreferrer"},wa=t(`<h2 id="_94-unicode-和-utf-8-之间的关系" tabindex="-1"><a class="header-anchor" href="#_94-unicode-和-utf-8-之间的关系" aria-hidden="true">#</a> 94. Unicode 和 UTF-8 之间的关系？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Unicode 是一种字符集合，现在可容纳 100 多万个字符。每个字符对应一个不同的 Unicode 编码，它只规定了符号的二进制代码，却没有规定这个二进制代码在计算机中如何编码传输。

UTF-8 是一种对 Unicode 的编码方式，它是一种变长的编码方式，可以用 1~4 个字节来表示一个字符。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ja={href:"https://blog.51cto.com/polaris/377468",target:"_blank",rel:"noopener noreferrer"},Sa={href:"http://www.ruanyifeng.com/blog/2007/10/ascii_unicode_and_utf-8.html",target:"_blank",rel:"noopener noreferrer"},qa=t(`<h2 id="_95-js-的事件循环是什么" tabindex="-1"><a class="header-anchor" href="#_95-js-的事件循环是什么" aria-hidden="true">#</a> 95. js 的事件循环是什么？</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>事件队列是一个存储着待执行任务的队列，其中的任务严格按照时间先后顺序执行，排在队头的任务将会率先执行，而排在队尾的任务会最后执行。事件队列每次仅执行一个任务，在该任务执行完毕之后，再执行下一个任务。执行栈则是一个类似于函数调用栈的运行容器，当执行栈为空时，JS 引擎便检查事件队列，如果不为空的话，事件队列便将第一个任务压入执行栈中运行。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>回答：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>因为 js 是单线程运行的，在代码执行的时候，通过将不同函数的执行上下文压入执行栈中来保证代码的有序执行。在执行同步代码的时候，如果遇到了异步事件，js 引擎并不会一直等待其返回结果，而是会将这个事件挂起，继续执行执行栈中的其他任务。当同步事件执行完毕后，再将异步事件对应的回调加入到与当前执行栈中不同的另一个任务队列中等待执行。任务队列可以分为宏任务对列和微任务对列，当当前执行栈中的事件执行完毕后，js 引擎首先会判断微任务对列中是否有任务可以执行，如果有就将微任务队首的事件压入栈中执行。当微任务对列中的任务都执行完成后再去判断宏任务对列中的任务。

微任务包括了 promise 的回调、node 中的 process.nextTick 、对 Dom 变化监听的 MutationObserver。

宏任务包括了 script 脚本的执行、setTimeout ，setInterval ，setImmediate 一类的定时事件，还有如 I/O 操作、UI 渲
染等。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Ea={href:"https://juejin.im/post/5afbc62151882542af04112d",target:"_blank",rel:"noopener noreferrer"},Ma={href:"https://zhuanlan.zhihu.com/p/33058983",target:"_blank",rel:"noopener noreferrer"},Oa={href:"http://www.ruanyifeng.com/blog/2013/10/event_loop.html",target:"_blank",rel:"noopener noreferrer"},Na={href:"https://juejin.im/post/59e85eebf265da430d571f89",target:"_blank",rel:"noopener noreferrer"},Aa=t(`<h2 id="_96-js-中的深浅拷贝实现" tabindex="-1"><a class="header-anchor" href="#_96-js-中的深浅拷贝实现" aria-hidden="true">#</a> 96. js 中的深浅拷贝实现？</h2><p>相关资料：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 浅拷贝的实现;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Ja={href:"https://github.com/mqyqingfeng/Blog/issues/32",target:"_blank",rel:"noopener noreferrer"},Ca={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bed40d951882545f73004f6",target:"_blank",rel:"noopener noreferrer"},Ta=t(`<h2 id="_97-手写-call、apply-及-bind-函数" tabindex="-1"><a class="header-anchor" href="#_97-手写-call、apply-及-bind-函数" aria-hidden="true">#</a> 97. 手写 call、apply 及 bind 函数</h2><p>相关资料：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// call函数实现</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Da={href:"https://github.com/mqyqingfeng/Blog/issues/42",target:"_blank",rel:"noopener noreferrer"},Ba=t(`<h2 id="_99-为什么-0-1-0-2-0-3-如何解决这个问题" tabindex="-1"><a class="header-anchor" href="#_99-为什么-0-1-0-2-0-3-如何解决这个问题" aria-hidden="true">#</a> 99. 为什么 0.1 + 0.2 != 0.3？如何解决这个问题？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>当计算机计算 0.1+0.2 的时候，实际上计算的是这两个数字在计算机里所存储的二进制，0.1 和 0.2 在转换为二进制表示的时候会出现位数无限循环的情况。js 中是以 64 位双精度格式来存储数字的，只有 53 位的有效数字，超过这个长度的位数会被截取掉这样就造成了精度丢失的问题。这是第一个会造成精度丢失的地方。在对两个以 64 位双精度格式的数据进行计算的时候，首先会进行对阶的处理，对阶指的是将阶码对齐，也就是将小数点的位置对齐后，再进行计算，一般是小阶向大阶对齐，因此小阶的数在对齐的过程中，有效数字会向右移动，移动后超过有效位数的位会被截取掉，这是第二个可能会出现精度丢失的地方。当两个数据阶码对齐后，进行相加运算后，得到的结果可能会超过 53 位有效数字，因此超过的位数也会被截取掉，这是可能发生精度丢失的第三个地方。

对于这样的情况，我们可以将其转换为整数后再进行运算，运算后再转换为对应的小数，以这种方式来解决这个问题。

我们还可以将两个数相加的结果和右边相减，如果相减的结果小于一个极小数，那么我们就可以认定结果是相等的，这个极小数可以
使用 es6 的 Number.EPSILON
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),La={href:"https://blog.csdn.net/Lixuanshengchao/article/details/82049191",target:"_blank",rel:"noopener noreferrer"},Va={href:"https://blog.csdn.net/zhengyanan815/article/details/78550073",target:"_blank",rel:"noopener noreferrer"},Fa={href:"http://www.ruanyifeng.com/blog/2010/06/ieee_floating-point_representation.html",target:"_blank",rel:"noopener noreferrer"},Ua={href:"https://juejin.im/post/5b372f106fb9a00e6714aa21",target:"_blank",rel:"noopener noreferrer"},za={href:"https://juejin.im/post/594a31d0a0bb9f006b0b2624",target:"_blank",rel:"noopener noreferrer"},Ha={href:"https://github.com/camsong/blog/issues/9",target:"_blank",rel:"noopener noreferrer"},Xa={href:"https://juejin.im/post/5bd2f10a51882555e072d0c4",target:"_blank",rel:"noopener noreferrer"},Wa={href:"https://juejin.im/entry/59cdd7fb6fb9a00a600f8eef",target:"_blank",rel:"noopener noreferrer"},Ga=t(`<h2 id="_100-原码、反码和补码的介绍" tabindex="-1"><a class="header-anchor" href="#_100-原码、反码和补码的介绍" aria-hidden="true">#</a> 100. 原码、反码和补码的介绍</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>原码是计算机中对数字的二进制的定点表示方法，最高位表示符号位，其余位表示数值位。优点是易于分辨，缺点是不能够直接参与运算。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),Ya={href:"https://juejin.im/post/5bad9140e51d450e935c6d64",target:"_blank",rel:"noopener noreferrer"},Za=t(`<h2 id="_103-什么是-csp" tabindex="-1"><a class="header-anchor" href="#_103-什么是-csp" aria-hidden="true">#</a> 103. 什么是 CSP？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>CSP 指的是内容安全策略，它的本质是建立一个白名单，告诉浏览器哪些外部资源可以加载和执行。我们只需要配置规则，如何拦截由浏览器自己来实现。

通常有两种方式来开启 CSP，一种是设置 HTTP 首部中的 Content-Security-Policy，一种是设置 meta 标签的方式 &lt;meta
http-equiv=&quot;Content-Security-Policy&quot;&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ka={href:"https://developer.mozilla.org/zh-CN/docs/Web/HTTP/CSP",target:"_blank",rel:"noopener noreferrer"},ne={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bdc721851882516c33430a2",target:"_blank",rel:"noopener noreferrer"},se=t(`<h2 id="_104-什么是-csrf-攻击-如何防范-csrf-攻击" tabindex="-1"><a class="header-anchor" href="#_104-什么是-csrf-攻击-如何防范-csrf-攻击" aria-hidden="true">#</a> 104. 什么是 CSRF 攻击？如何防范 CSRF 攻击？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>CSRF 攻击指的是跨站请求伪造攻击，攻击者诱导用户进入一个第三方网站，然后该网站向被攻击网站发送跨站请求。如果用户在被
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),ie={href:"https://www.jianshu.com/p/251704d8ff18",target:"_blank",rel:"noopener noreferrer"},le=t(`<h2 id="_107-sql-注入攻击" tabindex="-1"><a class="header-anchor" href="#_107-sql-注入攻击" aria-hidden="true">#</a> 107. SQL 注入攻击？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SQL 注入攻击指的是攻击者在 HTTP 请求中注入恶意的 SQL 代码，服务器使用参数构建数据库 SQL 命令时，恶意 SQL 被一起构
造，破坏原有 SQL 结构，并在数据库中执行，达到编写程序时意料之外结果的攻击行为。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2),oe={href:"https://juejin.im/post/5bd5b820e51d456f72531fa8",target:"_blank",rel:"noopener noreferrer"},pe={href:"http://blog.720ui.com/2016/security_web/#SQL%E6%B3%A8%E5%85%A5%E6%94%BB%E5%87%BB",target:"_blank",rel:"noopener noreferrer"},ce=t(`<h2 id="_108-什么是-mvvm-比之-mvc-有什么区别-什么又是-mvp" tabindex="-1"><a class="header-anchor" href="#_108-什么是-mvvm-比之-mvc-有什么区别-什么又是-mvp" aria-hidden="true">#</a> 108. 什么是 MVVM？比之 MVC 有什么区别？什么又是 MVP ？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>MVC、MVP 和 MVVM 是三种常见的软件架构设计模式，主要通过分离关注点的方式来组织代码结构，优化我们的开发效率。
...
能。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),re={href:"https://juejin.im/post/593021272f301e0058273468",target:"_blank",rel:"noopener noreferrer"},ue={href:"http://www.ruanyifeng.com/blog/2015/02/mvcmvp_mvvm.html",target:"_blank",rel:"noopener noreferrer"},de={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bdc72e6e51d45054f664dbf",target:"_blank",rel:"noopener noreferrer"},ve={href:"https://segmentfault.com/a/1190000015310674",target:"_blank",rel:"noopener noreferrer"},me=t(`<h2 id="_109-vue-双向数据绑定原理" tabindex="-1"><a class="header-anchor" href="#_109-vue-双向数据绑定原理" aria-hidden="true">#</a> 109. vue 双向数据绑定原理？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vue 通过使用双向数据绑定，来实现了 View 和 Model 的同步更新。vue 的双向数据绑定主要是通过使用数据劫持和发布订阅者模式来实现的。
...
据。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ke={href:"http://www.cnblogs.com/kidney/p/6052935.html?utm_source=gold_browser_extension",target:"_blank",rel:"noopener noreferrer"},be=t(`<h2 id="_110-object-defineproperty-介绍" tabindex="-1"><a class="header-anchor" href="#_110-object-defineproperty-介绍" aria-hidden="true">#</a> 110. Object.defineProperty 介绍？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Object.defineProperty 函数一共有三个参数，第一个参数是需要定义属性的对象，第二个参数是需要定义的属性，第三个是该属性描述符。

一个属性的描述符有四个属性，分别是 value 属性的值，writable 属性是否可写，enumerable 属性是否可枚举，configurable 属性是否可配置修改。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),he={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/defineProperty",target:"_blank",rel:"noopener noreferrer"},ge=t(`<h2 id="_111-使用-object-defineproperty-来进行数据劫持有什么缺点" tabindex="-1"><a class="header-anchor" href="#_111-使用-object-defineproperty-来进行数据劫持有什么缺点" aria-hidden="true">#</a> 111. 使用 Object.defineProperty() 来进行数据劫持有什么缺点？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>有一些对属性的操作，使用这种方法无法拦截，比如说通过下标方式修改数组数据或者给对象新增属性，vue 内部通过重写函数解决了这个问题。在 Vue3.0 中已经不使用这种方式了，而是通过使用 Proxy 对对象进行代理，从而实现数据劫持。使用 Proxy 的好处是它可以完美的监听到任何方式的数据改变，唯一的缺点是兼容性的问题，因为这是 ES6 的语法。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_112-什么是-virtual-dom-为什么-virtual-dom-比原生-dom-快" tabindex="-1"><a class="header-anchor" href="#_112-什么是-virtual-dom-为什么-virtual-dom-比原生-dom-快" aria-hidden="true">#</a> 112. 什么是 Virtual DOM？为什么 Virtual DOM 比原生 DOM 快？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我对 Virtual DOM 的理解是，
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),fe={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bdc72e6e51d45054f664dbf",target:"_blank",rel:"noopener noreferrer"},_e={href:"https://github.com/y8n/blog/issues/5",target:"_blank",rel:"noopener noreferrer"},xe={href:"https://github.com/livoras/blog/issues/13",target:"_blank",rel:"noopener noreferrer"},ye={href:"https://www.zhihu.com/question/31809713/answer/53544875",target:"_blank",rel:"noopener noreferrer"},we=t(`<h2 id="_113-如何比较两个-dom-树的差异" tabindex="-1"><a class="header-anchor" href="#_113-如何比较两个-dom-树的差异" aria-hidden="true">#</a> 113. 如何比较两个 DOM 树的差异？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>两个树的完全 diff 算法的时间复杂度为 O(n^3) ，但是在前端中，我们很少会跨层级的移动元素，所以我们只需要比较同一层级的元素进行比较，这样就可以将算法的时间复杂度降低为 O(n)。

算法首先会对新旧两棵树进行一个深度优先的遍历，这样每个节点都会有一个序号。在深度遍历的时候，每遍历到一个节点，我们就将这个节点和新的树中的节点进行比较，如果有差异，则将这个差异记录到一个对象中。

在对列表元素进行对比的时候，由于 TagName 是重复的，所以我们不能使用这个来对比。我们需要给每一个子节点加上一个 key，列表对比的时候使用 key 来进行比较，这样我们才能够复用老的 DOM 树上的节点。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_114-什么是-requestanimationframe" tabindex="-1"><a class="header-anchor" href="#_114-什么是-requestanimationframe" aria-hidden="true">#</a> 114. 什么是 requestAnimationFrame ？</h2>`,3),je={href:"https://juejin.im/post/5a82f0626fb9a06358657c9c",target:"_blank",rel:"noopener noreferrer"},Se={href:"https://www.zhangxinxu.com/wordpress/2013/09/css3-animation-requestanimationframe-tween-%E5%8A%A8%E7%94%BB%E7%AE%97%E6%B3%95/",target:"_blank",rel:"noopener noreferrer"},qe=t(`<h2 id="_115-谈谈你对-webpack-的看法" tabindex="-1"><a class="header-anchor" href="#_115-谈谈你对-webpack-的看法" aria-hidden="true">#</a> 115. 谈谈你对 webpack 的看法</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我当时使用 webpack 的一个最主要原因是为了简化页面依赖的管理，并且通过将其打包为一个文件来降低页面加载时请求的资源
数。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ee={href:"https://juejin.im/post/5b38d27451882574d87aa5d5#heading-0",target:"_blank",rel:"noopener noreferrer"},Me={href:"https://juejin.im/entry/5b5724d05188251aa01647fd",target:"_blank",rel:"noopener noreferrer"},Oe={href:"https://juejin.im/post/5afa9cd0f265da0b981b9af9#heading-0",target:"_blank",rel:"noopener noreferrer"},Ne={href:"https://juejin.im/entry/5ae5c8c9f265da0b9f400d8e",target:"_blank",rel:"noopener noreferrer"},Ae=t(`<h2 id="_116-offsetwidth-offsetheight-clientwidth-clientheight-与-scrollwidth-scrollheight-的区别" tabindex="-1"><a class="header-anchor" href="#_116-offsetwidth-offsetheight-clientwidth-clientheight-与-scrollwidth-scrollheight-的区别" aria-hidden="true">#</a> 116. offsetWidth/offsetHeight,clientWidth/clientHeight 与 scrollWidth/scrollHeight 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>clientWidth/clientHeight 返回的是元素的内部宽度，它的值只包含 content + padding，如果有滚动条，不包含滚动条。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),Ie={href:"https://www.zhihu.com/question/21950864",target:"_blank",rel:"noopener noreferrer"},De={href:"http://web.jobbole.com/83452/",target:"_blank",rel:"noopener noreferrer"},Be={href:"https://segmentfault.com/a/1190000006081973",target:"_blank",rel:"noopener noreferrer"},Le=t(`<h2 id="_122-get-和-post-请求在缓存方面的区别" tabindex="-1"><a class="header-anchor" href="#_122-get-和-post-请求在缓存方面的区别" aria-hidden="true">#</a> 122. get 和 post 请求在缓存方面的区别</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>get 请求类似于查找的过程，用户获取数据，可以不用每次都与数据库连接，所以可以使用缓存。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5),Ve={href:"https://blog.csdn.net/qq_27093465/article/details/50479289",target:"_blank",rel:"noopener noreferrer"},Fe=t(`<h2 id="_123-图片的懒加载和预加载" tabindex="-1"><a class="header-anchor" href="#_123-图片的懒加载和预加载" aria-hidden="true">#</a> 123. 图片的懒加载和预加载</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>预加载：提前加载图片，当用户需要查看时可直接从本地缓存中渲染。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Ue={href:"https://juejin.im/post/5b0c3b53f265da09253cbed0",target:"_blank",rel:"noopener noreferrer"},ze={href:"https://juejin.im/entry/5a73f38cf265da4e99575be3",target:"_blank",rel:"noopener noreferrer"},He={href:"https://www.zhangxinxu.com/wordpress/2016/06/image-preload-based-on-user-behavior/",target:"_blank",rel:"noopener noreferrer"},Xe=t(`<h2 id="_124-mouseover-和-mouseenter-的区别" tabindex="-1"><a class="header-anchor" href="#_124-mouseover-和-mouseenter-的区别" aria-hidden="true">#</a> 124. mouseover 和 mouseenter 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>当鼠标移动到元素上时就会触发 mouseenter 事件，类似 mouseover，它们两者之间的差别是 mouseenter 不会冒泡。

由于 mouseenter 不支持事件冒泡，导致在一个元素的子元素上进入或离开的时候会触发其 mouseover 和 mouseout 事件，但是却不会触发 mouseenter 和 mouseleave 事件。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),We={href:"https://github.com/qianlongo/zepto-analysis/issues/1",target:"_blank",rel:"noopener noreferrer"},Ge=t(`<h2 id="_125-js-拖拽功能的实现" tabindex="-1"><a class="header-anchor" href="#_125-js-拖拽功能的实现" aria-hidden="true">#</a> 125. js 拖拽功能的实现</h2><p>相关知识点：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>首先是三个事件，分别是 mousedown，mousemove，mouseup
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),Ye={href:"https://www.jianshu.com/p/32479bdfd851",target:"_blank",rel:"noopener noreferrer"},Ze={href:"https://zhuanlan.zhihu.com/p/51995737",target:"_blank",rel:"noopener noreferrer"},Ke=t(`<h2 id="_127-let-和-const-的注意点" tabindex="-1"><a class="header-anchor" href="#_127-let-和-const-的注意点" aria-hidden="true">#</a> 127. let 和 const 的注意点？</h2><ul><li>1.声明的变量只在声明时的代码块内有效</li><li>2.不存在声明提升</li><li>3.存在暂时性死区，如果在变量声明前使用，会报错</li><li>4.不允许重复声明，重复声明会报错</li></ul><h2 id="_128-什么是-rest-参数" tabindex="-1"><a class="header-anchor" href="#_128-什么是-rest-参数" aria-hidden="true">#</a> 128. 什么是 rest 参数？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>rest 参数（形式为...变量名），用于获取函数的多余参数。
...
（4）抛出 &quot;not found&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18),nt={href:"http://www.ruanyifeng.com/blog/2015/05/require.html",target:"_blank",rel:"noopener noreferrer"},st=t(`<h2 id="_136-什么是-promise-对象-什么是-promises-a-规范" tabindex="-1"><a class="header-anchor" href="#_136-什么是-promise-对象-什么是-promises-a-规范" aria-hidden="true">#</a> 136. 什么是 Promise 对象，什么是 Promises/A+ 规范？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Promise 对象是异步编程的一种解决方案，最早由社区提出。Promises/A+ 规范是 JavaScript Promise 的标准，规定了一个 Promise 所必须具有的特性。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),at={href:"http://www.ituring.com.cn/article/66566",target:"_blank",rel:"noopener noreferrer"},et={href:"http://es6.ruanyifeng.com/#docs/promise#Promise-resolve",target:"_blank",rel:"noopener noreferrer"},tt=t(`<h2 id="_137-手写一个-promise" tabindex="-1"><a class="header-anchor" href="#_137-手写一个-promise" aria-hidden="true">#</a> 137. 手写一个 Promise</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token constant">PENDING</span> <span class="token operator">=</span> <span class="token string">&quot;pending&quot;</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16),it={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bdc74186fb9a049ab0d0b6b",target:"_blank",rel:"noopener noreferrer"},lt={href:"https://juejin.im/post/59df4f74f265da430f311909#heading-3",target:"_blank",rel:"noopener noreferrer"},ot={href:"https://juejin.im/post/5afe6430518825428630bc4d",target:"_blank",rel:"noopener noreferrer"},pt=t(`<h2 id="_145-观察者模式和发布订阅模式有什么不同" tabindex="-1"><a class="header-anchor" href="#_145-观察者模式和发布订阅模式有什么不同" aria-hidden="true">#</a> 145. 观察者模式和发布订阅模式有什么不同？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>发布订阅模式其实属于广义上的观察者模式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),ut={href:"https://juejin.im/entry/5aee8fbb518825671952308c",target:"_blank",rel:"noopener noreferrer"},dt={href:"https://cn.vuejs.org/v2/guide/instance.html",target:"_blank",rel:"noopener noreferrer"},vt=t(`<h2 id="_148-vue-组件间的参数传递方式" tabindex="-1"><a class="header-anchor" href="#_148-vue-组件间的参数传递方式" aria-hidden="true">#</a> 148. Vue 组件间的参数传递方式？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）父子组件间通信
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),mt={href:"https://juejin.im/entry/5ba215ac5188255c6d0d8345",target:"_blank",rel:"noopener noreferrer"},kt=t(`<h2 id="_149-computed-和-watch-的差异" tabindex="-1"><a class="header-anchor" href="#_149-computed-和-watch-的差异" aria-hidden="true">#</a> 149. computed 和 watch 的差异？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）computed 是计算一个新的属性，并将该属性挂载到 Vue 实例上，而 watch 是监听已经存在且已挂载到 Vue 实例上的数据，所以用 watch 同样可以监听 computed 计算属性的变化。

（2）computed 本质是一个惰性求值的观察者，具有缓存性，只有当依赖变化后，第一次访问 computed 属性，才会计算新的值。而 watch 则是当数据发生变化便会调用执行函数。

（3）从使用场景上说，computed 适用一个数据被多个数据影响，而 watch 适用一个数据影响多个数据。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),bt={href:"https://juejin.im/post/5b98c4da6fb9a05d353c5fd7",target:"_blank",rel:"noopener noreferrer"},ht={href:"https://juejin.im/post/5af908ea5188254265399009",target:"_blank",rel:"noopener noreferrer"},gt=t(`<h2 id="_150-vue-router-中的导航钩子函数" tabindex="-1"><a class="header-anchor" href="#_150-vue-router-中的导航钩子函数" aria-hidden="true">#</a> 150. vue-router 中的导航钩子函数</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）全局的钩子函数 beforeEach 和 afterEach
...
件内部直接进行定义的。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),ft={href:"https://router.vuejs.org/zh/guide/advanced/navigation-guards.html#%E5%85%A8%E5%B1%80%E5%89%8D%E7%BD%AE%E5%AE%88%E5%8D%AB",target:"_blank",rel:"noopener noreferrer"},_t=t(`<h2 id="_151-route-和-router-的区别" tabindex="-1"><a class="header-anchor" href="#_151-route-和-router-的区别" aria-hidden="true">#</a> 151. $route 和 $router 的区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$route 是“路由信息对象”，包括 path，params，hash，query，fullPath，matched，name 等路由信息参数。而 $router 是“路由实例”对象包括了路由的跳转方法，钩子函数等。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),xt={href:"https://segmentfault.com/a/1190000016344599",target:"_blank",rel:"noopener noreferrer"},yt={href:"https://www.zhihu.com/question/61064119",target:"_blank",rel:"noopener noreferrer"},wt={href:"https://www.cnblogs.com/RainyBear/p/8563101.html",target:"_blank",rel:"noopener noreferrer"},jt=t(`<h2 id="_154-computed-和-watch-区别" tabindex="-1"><a class="header-anchor" href="#_154-computed-和-watch-区别" aria-hidden="true">#</a> 154. computed 和 watch 区别？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>computed 是计算属性，依赖其他属性计算值，并且 computed 的值有缓存，只有当计算值变化才会返回内容。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),St={href:"https://juejin.im/book/5bdc715fe51d454e755f75ef/section/5bdc731b51882516c56ced6f",target:"_blank",rel:"noopener noreferrer"},qt={href:"https://cn.vuejs.org/v2/guide/mixins.html",target:"_blank",rel:"noopener noreferrer"},Et=t(`<h2 id="_157-开发中常用的几种-content-type" tabindex="-1"><a class="header-anchor" href="#_157-开发中常用的几种-content-type" aria-hidden="true">#</a> 157. 开发中常用的几种 Content-Type ？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）application/x-www-form-urlencoded
...
该种方式主要用来提交 XML 格式的数据。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Mt={href:"https://honglu.me/2015/07/13/%E5%B8%B8%E7%94%A8%E7%9A%84%E5%87%A0%E7%A7%8DContent-Type/",target:"_blank",rel:"noopener noreferrer"},Ot=t(`<h2 id="_158-如何封装一个-javascript-的类型判断函数" tabindex="-1"><a class="header-anchor" href="#_158-如何封装一个-javascript-的类型判断函数" aria-hidden="true">#</a> 158. 如何封装一个 javascript 的类型判断函数？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">getType</span><span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Nt={href:"https://github.com/mqyqingfeng/Blog/issues/28",target:"_blank",rel:"noopener noreferrer"},At=t(`<h2 id="_159-如何判断一个对象是否为空对象" tabindex="-1"><a class="header-anchor" href="#_159-如何判断一个对象是否为空对象" aria-hidden="true">#</a> 159. 如何判断一个对象是否为空对象？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">checkNullObj</span><span class="token punctuation">(</span><span class="token parameter">obj</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Jt={href:"https://blog.csdn.net/FungLeo/article/details/78113661",target:"_blank",rel:"noopener noreferrer"},Ct=t(`<h2 id="_160-使用闭包实现每隔一秒打印-1-2-3-4" tabindex="-1"><a class="header-anchor" href="#_160-使用闭包实现每隔一秒打印-1-2-3-4" aria-hidden="true">#</a> 160. 使用闭包实现每隔一秒打印 1,2,3,4</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 使用闭包实现</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),Tt={href:"https://www.cnblogs.com/zzc5464/p/jsonp.html",target:"_blank",rel:"noopener noreferrer"},Pt={href:"https://segmentfault.com/a/1190000007665361#articleHeader1",target:"_blank",rel:"noopener noreferrer"},Rt=t(`<h2 id="_162-手写一个观察者模式" tabindex="-1"><a class="header-anchor" href="#_162-手写一个观察者模式" aria-hidden="true">#</a> 162. 手写一个观察者模式？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> events <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),It={href:"https://segmentfault.com/a/1190000006934031#articleHeader1",target:"_blank",rel:"noopener noreferrer"},Dt=t(`<h2 id="_163-eventemitter-实现" tabindex="-1"><a class="header-anchor" href="#_163-eventemitter-实现" aria-hidden="true">#</a> 163. EventEmitter 实现</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">EventEmitter</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),Bt={href:"https://github.com/Wscats/Good-text-Share/issues/85",target:"_blank",rel:"noopener noreferrer"},Lt={href:"https://segmentfault.com/q/1010000008430170",target:"_blank",rel:"noopener noreferrer"},Vt={href:"https://www.cnblogs.com/xxcanghai/p/5189353.html",target:"_blank",rel:"noopener noreferrer"},Ft=t(`<h2 id="_165-如何确定页面的可用性时间-什么是-performance-api" tabindex="-1"><a class="header-anchor" href="#_165-如何确定页面的可用性时间-什么是-performance-api" aria-hidden="true">#</a> 165. 如何确定页面的可用性时间，什么是 Performance API？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Performance API 用于精确度量、控制、增强浏览器的性能表现。这个 API 为测量网站性能，提供以前没有办法做到的精度。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,4),Ut={href:"http://javascript.ruanyifeng.com/bom/performance.html",target:"_blank",rel:"noopener noreferrer"},zt=t(`<h2 id="_166-js-中的命名规则" tabindex="-1"><a class="header-anchor" href="#_166-js-中的命名规则" aria-hidden="true">#</a> 166. js 中的命名规则</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>（1）第一个字符必须是字母、下划线（_）或美元符号（$）
（2）余下的字符可以是下划线、美元符号或任何字母或数字字符

一般我们推荐使用驼峰法来对变量名进行命名，因为这样可以与 ECMAScript 内置的函数和对象命名格式保持一致。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Ht={href:"http://www.w3school.com.cn/js/pro_js_variables.asp",target:"_blank",rel:"noopener noreferrer"},Xt=t(`<h2 id="_167-js-语句末尾分号是否可以省略" tabindex="-1"><a class="header-anchor" href="#_167-js-语句末尾分号是否可以省略" aria-hidden="true">#</a> 167. js 语句末尾分号是否可以省略？</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在 ECMAScript 规范中，语句结尾的分号并不是必需的。但是我们一般最好不要省略分号，因为加上分号一方面有
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),Wt={href:"https://juejin.im/post/5badf8305188255c8e728adc",target:"_blank",rel:"noopener noreferrer"},Gt=n("h2",{id:"_173-进程间通信的方式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_173-进程间通信的方式","aria-hidden":"true"},"#"),s(" 173. 进程间通信的方式？")],-1),$t=n("ul",null,[n("li",null,"1.管道通信"),n("li",null,"2.消息队列通信"),n("li",null,"3.信号量通信"),n("li",null,"4.信号通信"),n("li",null,"5.共享内存通信"),n("li",null,"6.套接字通信")],-1),Qt={href:"https://blog.csdn.net/violet_echo_0908/article/details/51201278",target:"_blank",rel:"noopener noreferrer"},Yt={href:"http://www.ruanyifeng.com/blog/2013/04/processes_and_threads.html",target:"_blank",rel:"noopener noreferrer"},Zt=t(`<h2 id="_174-如何查找一篇英文文章中出现频率最高的单词" tabindex="-1"><a class="header-anchor" href="#_174-如何查找一篇英文文章中出现频率最高的单词" aria-hidden="true">#</a> 174. 如何查找一篇英文文章中出现频率最高的单词？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">findMostWord</span><span class="token punctuation">(</span><span class="token parameter">article</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_175-ele-getelementsbyclassname和ele-queryselectorall的区别" tabindex="-1"><a class="header-anchor" href="#_175-ele-getelementsbyclassname和ele-queryselectorall的区别" aria-hidden="true">#</a> 175. ele.getElementsByClassName和ele.querySelectorAll的区别？</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>element<span class="token punctuation">.</span>getElementsByClassName 返回一个即时更新（动态的）HTMLCollection
element<span class="token punctuation">.</span>querySelectorAll 返回一个非即时更新（静态的） NodeList
<span class="token comment">// 先说什么叫即时更新，（前者是动态的，改变 DOM 结构会同步，后者只会记录调用 api 时的结果，不懂可以看下面的例子）</span>
<span class="token operator">&lt;</span>div id<span class="token operator">=</span><span class="token string">&quot;parent&quot;</span><span class="token operator">&gt;</span>
  <span class="token operator">&lt;</span>p <span class="token keyword">class</span><span class="token operator">=</span><span class="token string">&quot;p&quot;</span><span class="token operator">&gt;</span><span class="token number">1</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">&gt;</span>
  <span class="token operator">&lt;</span>p <span class="token keyword">class</span><span class="token operator">=</span><span class="token string">&quot;p&quot;</span><span class="token operator">&gt;</span><span class="token number">2</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">&gt;</span>
  <span class="token operator">&lt;</span>p <span class="token keyword">class</span><span class="token operator">=</span><span class="token string">&quot;p&quot;</span><span class="token operator">&gt;</span><span class="token number">3</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">&gt;</span>
<span class="token operator">&lt;</span><span class="token operator">/</span>div<span class="token operator">&gt;</span>
<span class="token operator">&lt;</span>script<span class="token operator">&gt;</span>
<span class="token keyword">let</span> list1 <span class="token operator">=</span> parent<span class="token punctuation">.</span><span class="token function">getElementsByClassName</span><span class="token punctuation">(</span><span class="token string">&#39;p&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">let</span> list2 <span class="token operator">=</span> parent<span class="token punctuation">.</span><span class="token function">querySelectorAll</span><span class="token punctuation">(</span><span class="token string">&#39;.p&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>list1<span class="token punctuation">.</span>length1<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 3</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>list2<span class="token punctuation">.</span>length1<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 3</span>
<span class="token keyword">let</span> newP <span class="token operator">=</span> docuemnt<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&quot;p&quot;</span><span class="token punctuation">)</span>
newP<span class="token punctuation">.</span>classList<span class="token punctuation">.</span><span class="token function">add</span><span class="token punctuation">(</span><span class="token string">&#39;p&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
parent<span class="token punctuation">.</span><span class="token function">appendChild</span><span class="token punctuation">(</span>newP<span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>list1<span class="token punctuation">.</span>length1<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 4 (即时更新)</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>list2<span class="token punctuation">.</span>length1<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 3（非即时更新）</span>
<span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">&gt;</span>
<span class="token comment">// 在说下返回值</span>
<span class="token comment">// HTMLCollection 和 NodeList 都是类数组形式</span>
如下一个 div 可以看成是 HTMLDivElement 的实例，其中 Node 的集合为 NodeList；Element 的集合为 HTMLCollection
EventTarget <span class="token operator">-</span> Node <span class="token operator">-</span> Element <span class="token operator">-</span> HTMLElement <span class="token operator">-</span> HTMLDivElement<span class="token operator">&lt;</span>br<span class="token operator">&gt;</span>
EventTarget <span class="token operator">-</span> Node <span class="token operator">-</span> Element <span class="token operator">-</span> SVGElement <span class="token operator">-</span> SVGPathElement<span class="token operator">&lt;</span>br<span class="token operator">&gt;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),Kt={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/HTMLDivElement",target:"_blank",rel:"noopener noreferrer"};function ni(si,ai){const a=l("ExternalLinkIcon");return o(),p("div",null,[r,n("p",null,[s("详细资料可以参考： "),n("a",u,[s("《JavaScript 有几种类型的值？》"),e(a)]),n("a",d,[s("《JavaScript 有几种类型的值？能否画一下它们的内存图；》"),e(a)])]),v,n("p",null,[s("详细资料可以参考： "),n("a",m,[s("《什么是堆？什么是栈？他们之间有什么区别和联系？》"),e(a)])]),k,n("p",null,[s("详细资料可以参考： "),n("a",b,[s("《标准内置对象的分类》"),e(a)]),n("a",h,[s("《JS 所有内置对象属性和方法汇总》"),e(a)])]),g,n("p",null,[s("详细资料可以参考： "),n("a",f,[s("《JavaScript 深入理解之 undefined 与 null》"),e(a)])]),_,n("p",null,[s("详细资料可以参考： "),n("a",x,[s("《JavaScript 深入理解之原型与原型链》"),e(a)])]),y,n("p",null,[s("详细资料可以参考： "),n("a",w,[s("《JavaScript 字符串间的比较》"),e(a)])]),j,n("p",null,[s("详细资料可以参考： "),n("a",S,[s("《详解 JS 中 Number()、parseInt() 和 parseFloat() 的区别》"),e(a)])]),q,n("p",null,[s("详细资料可以参考： "),n("a",E,[s("《前端表单验证常用的 15 个 JS 正则表达式》"),e(a)]),n("a",M,[s("《JS 常用正则汇总》"),e(a)])]),O,n("p",null,[n("a",N,[s("《JS - 生成随机数的方法汇总（不同范围、类型的随机数）》"),e(a)])]),A,n("p",null,[s("详细资料可以参考： "),n("a",J,[s("《Fisher and Yates 的原始版》"),e(a)]),n("a",C,[s("《javascript 实现数组随机排序?》"),e(a)]),n("a",T,[s("《JavaScript 学习笔记：数组随机排序》"),e(a)])]),P,n("p",null,[s("详细资料可以参考： "),n("a",R,[s("《JavaScript 深入理解之对象创建》"),e(a)])]),I,n("p",null,[s("详细资料可以参考： "),n("a",D,[s("《JavaScript 深入理解之继承》"),e(a)])]),B,n("p",null,[s("详细资料可以参考： "),n("a",L,[s("《JavaScript 深入理解之作用域链》"),e(a)])]),V,n("p",null,[n("a",F,[s("《JavaScript 深入理解之 this 详解》"),e(a)])]),U,n("p",null,[s("详细资料可以参考： "),n("a",z,[s("《eval()》"),e(a)])]),H,n("p",null,[s("详细资料可以参考： "),n("a",X,[s("《DOM, DOCUMENT, BOM, WINDOW 有什么区别?》"),e(a)]),n("a",W,[s("《Window 对象》"),e(a)]),n("a",G,[s("《DOM 与 BOM 分别是什么，有何关联？》"),e(a)]),n("a",$,[s("《JavaScript 学习总结（三）BOM 和 DOM 详解》"),e(a)])]),Q,n("p",null,[s("详细资料可以参考： "),n("a",Y,[s("《JS 事件模型》"),e(a)])]),Z,K,n("p",null,[s("详细资料可以参考： "),n("a",nn,[s("《Javascript 事件模型系列（一）事件及事件的三种模型》"),e(a)]),n("a",sn,[s("《Javascript 事件模型：事件捕获和事件冒泡》"),e(a)])]),an,n("p",null,[s("详细资料可以参考： "),n("a",en,[s("《一个 DOM 元素绑定多个事件时，先执行冒泡还是捕获》"),e(a)])]),tn,n("p",null,[s("详细资料可以参考： "),n("a",ln,[s("《JavaScript 事件委托详解》"),e(a)])]),on,n("p",null,[s("详细资料可以参考： "),n("a",pn,[s('《为什么 ["1", "2", "3"].map(parseInt) 返回 [1,NaN,NaN]？》'),e(a)])]),cn,n("p",null,[s("详细资料可以参考： "),n("a",rn,[s("《JavaScript 深入理解之闭包》"),e(a)])]),un,n("p",null,[s("详细资料可以参考： "),n("a",dn,[s("《Javascript 严格模式详解》"),e(a)])]),vn,n("p",null,[s("详细资料可以参考： "),n("a",mn,[s("《js 判断一个对象是否属于某一类》"),e(a)])]),kn,n("p",null,[s("详细资料可以参考： "),n("a",bn,[s("《instanceof》"),e(a)])]),hn,n("p",null,[s("详细资料可以参考： "),n("a",gn,[s("《new 操作符具体干了什么？》"),e(a)]),n("a",fn,[s("《JavaScript 深入之 new 的模拟实现》"),e(a)])]),_n,n("p",null,[s("详细资料可以参考： "),n("a",xn,[s("《Object.prototype.hasOwnProperty()》"),e(a)])]),yn,n("p",null,[s("详细资料可以参考： "),n("a",wn,[s("《深入了解 JavaScript 中的 JSON 》"),e(a)])]),jn,n("p",null,[s("详细资料可以参考： "),n("a",Sn,[s("《通过一行代码学 JavaScript》"),e(a)])]),qn,n("p",null,[s("详细资料可以参考： "),n("a",En,[s("《JS 延迟加载的几种方式》"),e(a)]),n("a",Mn,[s("《HTML 5 "),On,s(),Nn,s(" 属性》"),e(a)])]),An,n("p",null,[s("详细资料可以参考： "),n("a",Jn,[s("《XMLHttpRequest 对象》"),e(a)]),n("a",Cn,[s("《从 ajax 到 fetch、axios》"),e(a)]),n("a",Tn,[s("《Fetch 入门》"),e(a)]),n("a",Pn,[s("《传统 Ajax 已死，Fetch 永生》"),e(a)])]),Rn,n("p",null,[s("详细资料可以参考： "),n("a",In,[s("《浅谈浏览器缓存》"),e(a)]),n("a",Dn,[s("《前端优化：浏览器缓存技术介绍》"),e(a)]),n("a",Bn,[s("《请求头中的 Cache-Control》"),e(a)]),n("a",Ln,[s("《Cache-Control 字段值详解》"),e(a)])]),Vn,n("p",null,[s("详细资料可以参考： "),n("a",Fn,[s("《Ajax 中浏览器的缓存问题解决方法》"),e(a)]),n("a",Un,[s("《浅谈浏览器缓存》"),e(a)])]),zn,n("p",null,[s("详细资料可以参考： "),n("a",Hn,[s("《同步和异步的区别》"),e(a)])]),Xn,n("p",null,[s("详细资料可以参考： "),n("a",Wn,[s("《前端常见跨域解决方案（全）》"),e(a)]),n("a",Gn,[s("《浏览器同源政策及其规避方法》"),e(a)]),n("a",$n,[s("《跨域，你需要知道的全在这里》"),e(a)]),n("a",Qn,[s("《为什么 form 表单提交没有跨域问题，但 ajax 提交有跨域问题？》"),e(a)])]),Yn,n("p",null,[s("详细资料可以参考： "),n("a",Zn,[s("《深入浅出 Nginx》"),e(a)])]),Kn,n("p",null,[s("详细资料可以参考： "),n("a",ns,[s("《HTTP cookies》 "),e(a)]),n("a",ss,[s("《聊一聊 cookie》 "),e(a)])]),as,n("p",null,[s("详细资料可以参考： "),n("a",es,[s("《浅谈模块化开发》"),e(a)]),n("a",ts,[s("《Javascript 模块化编程（一）：模块的写法》"),e(a)]),n("a",is,[s("《前端模块化：CommonJS，AMD，CMD，ES6》"),e(a)]),n("a",ls,[s("《Module 的语法》"),e(a)])]),os,n("p",null,[s("详细资料可以参考： "),n("a",ps,[s("《前端模块化，AMD 与 CMD 的区别》"),e(a)])]),cs,n("p",null,[s("详细资料可以参考： "),n("a",rs,[s("《requireJS 的用法和原理分析》"),e(a)]),n("a",us,[s("《requireJS 的核心原理是什么？》"),e(a)]),n("a",ds,[s("《从 RequireJs 源码剖析脚本加载原理》"),e(a)]),n("a",vs,[s("《requireJS 原理分析》"),e(a)])]),ms,n("p",null,[s("详细资料可以参考： "),n("a",ks,[s("《JS 模块加载器加载原理是怎么样的？》"),e(a)])]),bs,n("p",null,[s("详细资料可以参考： "),n("a",hs,[s("《ECMAScript 6 实现了 class，对 JavaScript 前端开发有什么意义？》"),e(a)]),n("a",gs,[s("《Class 的基本语法》"),e(a)])]),fs,n("p",null,[s("详细资料可以参考： "),n("a",_s,[s("《简述 document.write 和 innerHTML 的区别。》"),e(a)])]),xs,n("p",null,[s("详细资料可以参考： "),n("a",ys,[s("《DOM 概述》"),e(a)]),n("a",ws,[s("《原生 JavaScript 的 DOM 操作汇总》"),e(a)]),n("a",js,[s("《原生 JS 中 DOM 节点相关 API 合集》"),e(a)])]),Ss,n("p",null,[s("详细资料可以参考： "),n("a",qs,[s("《apply、call 的区别和用途》"),e(a)])]),Es,n("p",null,[s("详细的资料可以参考： "),n("a",Ms,[s("《JavaScript 深入之类数组对象与 arguments》"),e(a)]),n("a",Os,[s("《javascript 类数组》"),e(a)]),n("a",Ns,[s("《深入理解 JavaScript 类数组》"),e(a)])]),As,n("p",null,[s("详细资料可以参考： "),n("a",Js,[s("《JavaScript 深入理解之 Array 类型详解》"),e(a)])]),Cs,n("p",null,[s("详细资料可以参考： "),n("a",Ts,[s("《Array.prototype.fill()》"),e(a)])]),Ps,n("p",null,[s("详细资料可以参考： "),n("a",Rs,[s("《尾后逗号》"),e(a)])]),Is,n("p",null,[s("详细资料可以参考： "),n("a",Ds,[s("《JavaScript 深入理解之变量对象》"),e(a)])]),Bs,Ls,n("p",null,[s("详细资料可以参考： "),n("a",Vs,[s("《如何编写高性能的 Javascript？》"),e(a)])]),Fs,n("p",null,[s("详细资料可以参考： "),n("a",Us,[s("《深入理解 V8 的垃圾回收原理》"),e(a)]),n("a",zs,[s("《JavaScript 中的垃圾回收》"),e(a)])]),Hs,n("p",null,[s("详细资料可以参考： "),n("a",Xs,[s("《JavaScript 内存泄漏教程》"),e(a)]),n("a",Ws,[s("《4 类 JavaScript 内存泄漏及如何避免》"),e(a)]),n("a",Gs,[s("《杜绝 js 中四种内存泄漏类型的发生》"),e(a)]),n("a",$s,[s("《javascript 典型内存泄漏及 chrome 的排查方法》"),e(a)])]),Qs,n("p",null,[s("详细资料可以参考： "),n("a",Ys,[s("《pushState + ajax 实现浏览器无刷新前进后退》"),e(a)]),n("a",Zs,[s("《Manipulating the browser history》"),e(a)])]),Ks,n("p",null,[s("详细资料可以参考： "),n("a",na,[s("《为什么把 script 标签放在 body 结束标签之后 html 结束标签之前？》"),e(a)]),n("a",sa,[s("《从 Chrome 源码看浏览器如何加载资源》"),e(a)])]),aa,n("p",null,[s("详细资料可以参考： "),n("a",ea,[s("《移动端 300ms 点击延迟和点击穿透》"),e(a)])]),ta,n("p",null,[s("详细资料可以参考： "),n("a",ia,[s("《什么是“前端路由”》"),e(a)]),n("a",la,[s("《浅谈前端路由》 "),e(a)]),n("a",oa,[s("《前端路由是什么东西？》"),e(a)])]),pa,n("p",null,[s("详细资料可以参考： "),n("a",ca,[s("《浅谈前端单元测试》"),e(a)])]),ra,n("p",null,[s("详细资料可以参考： "),n("a",ua,[s("《JavaScript 判断浏览器类型》"),e(a)])]),da,n("p",null,[s("详细资料可以参考： "),n("a",va,[s("《Web 开发中的“黑话”》"),e(a)]),n("a",ma,[s("《Polyfill 为何物》"),e(a)])]),ka,n("p",null,[s("详细资料可以参考： "),n("a",ba,[s("《如何更有效的获取文件扩展名》"),e(a)])]),ha,n("p",null,[s("详细资料可以参考： "),n("a",ga,[s("《轻松理解 JS 函数节流和函数防抖》"),e(a)]),n("a",fa,[s("《JavaScript 事件节流和事件防抖》"),e(a)]),n("a",_a,[s("《JS 的防抖与节流》"),e(a)])]),xa,n("p",null,[s("详细资料可以参考： "),n("a",ya,[s("《escape,encodeURI,encodeURIComponent 有什么区别?》"),e(a)])]),wa,n("p",null,[s("详细资料可以参考： "),n("a",ja,[s("《字符编码详解》"),e(a)]),n("a",Sa,[s("《字符编码笔记：ASCII，Unicode 和 UTF-8》"),e(a)])]),qa,n("p",null,[s("详细资料可以参考： "),n("a",Ea,[s("《浏览器事件循环机制（event loop）》"),e(a)]),n("a",Ma,[s("《详解 JavaScript 中的 Event Loop（事件循环）机制》"),e(a)]),n("a",Oa,[s("《什么是 Event Loop？》"),e(a)]),n("a",Na,[s("《这一次，彻底弄懂 JavaScript 执行机制》"),e(a)])]),Aa,n("p",null,[s("详细资料可以参考： "),n("a",Ja,[s("《JavaScript 专题之深浅拷贝》"),e(a)]),n("a",Ca,[s("《前端面试之道》"),e(a)])]),Ta,n("p",null,[s("详细资料可以参考： "),n("a",Pa,[s("《手写 call、apply 及 bind 函数》"),e(a)]),n("a",Ra,[s("《JavaScript 深入之 call 和 apply 的模拟实现》"),e(a)])]),Ia,n("p",null,[s("详细资料可以参考： "),n("a",Da,[s("《JavaScript 专题之函数柯里化》"),e(a)])]),Ba,n("p",null,[s("详细资料可以参考： "),n("a",La,[s("《十进制的 0.1 为什么不能用二进制很好的表示？》"),e(a)]),n("a",Va,[s("《十进制浮点数转成二进制》"),e(a)]),n("a",Fa,[s("《浮点数的二进制表示》"),e(a)]),n("a",Ua,[s("《js 浮点数存储精度丢失原理》"),e(a)]),n("a",za,[s("《浮点数精度之谜》"),e(a)]),n("a",Ha,[s("《JavaScript 浮点数陷阱及解法》"),e(a)]),n("a",Xa,[s("《0.1+0.2 !== 0.3？》"),e(a)]),n("a",Wa,[s("《JavaScript 中奇特的~运算符》"),e(a)])]),Ga,n("p",null,[s("详细资料可以参考： "),n("a",$a,[s("《关于 2 的补码》"),e(a)])]),Qa,n("p",null,[s("详细资料可以参考： "),n("a",Ya,[s("《前端安全系列（一）：如何防止 XSS 攻击？》"),e(a)])]),Za,n("p",null,[s("详细资料可以参考： "),n("a",Ka,[s("《内容安全策略（CSP）》"),e(a)]),n("a",ne,[s("《前端面试之道》"),e(a)])]),se,n("p",null,[s("详细资料可以参考： "),n("a",ae,[s("《前端安全系列之二：如何防止 CSRF 攻击？》"),e(a)]),n("a",ee,[s("《[ HTTP 趣谈] origin, referer 和 host 区别》"),e(a)])]),te,n("p",null,[s("详细资料可以参考： "),n("a",ie,[s("《web 安全之--点击劫持攻击与防御技术简介》"),e(a)])]),le,n("p",null,[s("详细资料可以参考： "),n("a",oe,[s("《Web 安全漏洞之 SQL 注入》"),e(a)]),n("a",pe,[s("《如何防范常见的 Web 攻击》"),e(a)])]),ce,n("p",null,[s("详细资料可以参考： "),n("a",re,[s("《浅析前端开发中的 MVC/MVP/MVVM 模式》"),e(a)]),n("a",ue,[s("《MVC，MVP 和 MVVM 的图示》"),e(a)]),n("a",de,[s("《MVVM》"),e(a)]),n("a",ve,[s("《一篇文章了解架构模式：MVC/MVP/MVVM》"),e(a)])]),me,n("p",null,[s("详细资料可以参考： "),n("a",ke,[s("《Vue.js 双向绑定的实现原理》"),e(a)])]),be,n("p",null,[s("详细资料可以参考： "),n("a",he,[s("《Object.defineProperty()》"),e(a)])]),ge,n("p",null,[s("详细资料可以参考： "),n("a",fe,[s("《Virtual DOM》"),e(a)]),n("a",_e,[s("《理解 Virtual DOM》"),e(a)]),n("a",xe,[s("《深度剖析：如何实现一个 Virtual DOM 算法》"),e(a)]),n("a",ye,[s("《网上都说操作真实 DOM 慢，但测试结果却比 React 更快，为什么？》"),e(a)])]),we,n("p",null,[s("详细资料可以参考： "),n("a",je,[s("《你需要知道的 requestAnimationFrame》"),e(a)]),n("a",Se,[s("《CSS3 动画那么强，requestAnimationFrame 还有毛线用？》"),e(a)])]),qe,n("p",null,[s("详细资料可以参考： "),n("a",Ee,[s("《不聊 webpack 配置，来说说它的原理》"),e(a)]),n("a",Me,[s("《前端工程化——构建工具选型：grunt、gulp、webpack》"),e(a)]),n("a",Oe,[s("《浅入浅出 webpack》"),e(a)]),n("a",Ne,[s("《前端构建工具发展及其比较》"),e(a)])]),Ae,n("p",null,[s("详细资料可以参考： "),n("a",Je,[s("《最全的获取元素宽高及位置的方法》"),e(a)]),n("a",Ce,[s("《用 Javascript 获取页面元素的位置》"),e(a)])]),Te,n("p",null,[s("详细资料可以参考： "),n("a",Pe,[s("《函数式编程初探》"),e(a)])]),Re,n("p",null,[s("详细资料可以参考： "),n("a",Ie,[s("《HTTP 协议中 URI 和 URL 有什么区别？》"),e(a)]),n("a",De,[s("《你知道 URL、URI 和 URN 三者之间的区别吗？》"),e(a)]),n("a",Be,[s("《URI、URL 和 URN 的区别》"),e(a)])]),Le,n("p",null,[s("详细资料可以参考： "),n("a",Ve,[s("《HTML 关于 post 和 get 的区别以及缓存问题的理解》"),e(a)])]),Fe,n("p",null,[s("详细资料可以参考： "),n("a",Ue,[s("《懒加载和预加载》"),e(a)]),n("a",ze,[s("《网页图片加载优化方案》"),e(a)]),n("a",He,[s("《基于用户行为的图片等资源预加载》"),e(a)])]),Xe,n("p",null,[s("详细资料可以参考： "),n("a",We,[s("《mouseenter 与 mouseover 为何这般纠缠不清？》"),e(a)])]),Ge,n("p",null,[s("详细资料可以参考： "),n("a",$e,[s("《原生 js 实现拖拽功能基本思路》"),e(a)])]),Qe,n("p",null,[s("详细资料可以参考： "),n("a",Ye,[s("《用 setTimeout 实现 setInterval》"),e(a)]),n("a",Ze,[s("《setInterval 有什么缺点？》"),e(a)])]),Ke,n("p",null,[s("详细资料可以参考： "),n("a",nt,[s("《require() 源码解读》"),e(a)])]),st,n("p",null,[s("详细资料可以参考： "),n("a",at,[s("《Promises/A+ 规范》"),e(a)]),n("a",et,[s("《Promise》"),e(a)])]),tt,n("p",null,[s("更多关于设计模式的资料可以参考： "),n("a",it,[s("《前端面试之道》"),e(a)]),n("a",lt,[s("《JavaScript 设计模式》"),e(a)]),n("a",ot,[s("《JavaScript 中常见设计模式整理》"),e(a)])]),pt,n("p",null,[s("详细资料可以参考： "),n("a",ct,[s("《观察者模式和发布订阅模式有什么不同？》"),e(a)])]),rt,n("p",null,[s("详细资料可以参考： "),n("a",ut,[s("《vue 生命周期深入》"),e(a)]),n("a",dt,[s("《Vue 实例》"),e(a)])]),vt,n("p",null,[s("详细资料可以参考： "),n("a",mt,[s("《VUE 组件之间数据传递全集》"),e(a)])]),kt,n("p",null,[s("详细资料可以参考： "),n("a",bt,[s("《做面试的不倒翁：浅谈 Vue 中 computed 实现原理》"),e(a)]),n("a",ht,[s("《深入理解 Vue 的 watch 实现原理及其实现方式》"),e(a)])]),gt,n("p",null,[s("详细资料可以参考： "),n("a",ft,[s("《导航守卫》"),e(a)])]),_t,n("p",null,[s("详细资料可以参考： "),n("a",xt,[s("《Vue 面试中，经常会被问到的面试题 Vue 知识点整理》"),e(a)]),n("a",yt,[s("《Vue2.0 v-for 中 :key 到底有什么用？》"),e(a)]),n("a",wt,[s("《vue 中 key 的作用》"),e(a)])]),jt,n("p",null,[s("详细资料可以参考： "),n("a",St,[s("《前端面试之道》"),e(a)]),n("a",qt,[s("《混入》"),e(a)])]),Et,n("p",null,[s("详细资料可以参考： "),n("a",Mt,[s("《常用的几种 Content-Type》"),e(a)])]),Ot,n("p",null,[s("详细资料可以参考： "),n("a",Nt,[s("《JavaScript 专题之类型判断(上)》"),e(a)])]),At,n("p",null,[s("详细资料可以参考： "),n("a",Jt,[s("《js 判断一个 object 对象是否为空》"),e(a)])]),Ct,n("p",null,[s("详细资料可以参考： "),n("a",Tt,[s("《原生 jsonp 具体实现》"),e(a)]),n("a",Pt,[s("《jsonp 的原理与实现》"),e(a)])]),Rt,n("p",null,[s("详细资料可以参考： "),n("a",It,[s("《JS 事件模型》"),e(a)])]),Dt,n("p",null,[s("详细资料可以参考： "),n("a",Bt,[s("《前端程序员经常忽视的一个 JavaScript 面试题》"),e(a)]),n("a",Lt,[s("《一道考察运算符优先级的 JavaScript 面试题》"),e(a)]),n("a",Vt,[s("《一道常被人轻视的前端 JS 面试题》"),e(a)])]),Ft,n("p",null,[s("详细资料可以参考： "),n("a",Ut,[s("《Performance API》"),e(a)])]),zt,n("p",null,[s("详细资料可以参考： "),n("a",Ht,[s("《ECMAScript 变量》"),e(a)])]),Xt,n("p",null,[s("详细资料可以参考： "),n("a",Wt,[s("《JavaScript 前端倒计时纠偏实现》"),e(a)])]),Gt,$t,n("p",null,[s("详细资料可以参考： "),n("a",Qt,[s("《进程间 8 种通信方式详解》"),e(a)]),n("a",Yt,[s("《进程与线程的一个简单解释》"),e(a)])]),Zt,n("p",null,[n("a",Kt,[s("MDN 上元素 div 继承关系"),e(a)])])])}const ti=i(c,[["render",ni],["__file","JavaScript.html.vue"]]);export{ti as default};
